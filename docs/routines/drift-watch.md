...
- **i18n completeness** — all user-facing strings via `<FormattedMessage>` or `intl.formatMessage()`; locale files in sync; no hardcoded English in components or aria-labels.
