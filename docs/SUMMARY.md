...
* [Why Green Goods](welcome/why-green-goods.md)
* [Who Is Green Goods For?](welcome/who-is-it-for.md)
* [What You Can Do](welcome/what-you-can-do.md)
...
* [Gardens, Assessments, Actions & Work](concepts/gardens-and-work.md)
* [MDR Workflow (Media → Details → Review)](concepts/mdr-workflow.md)
* [Attestations & On-Chain Records](concepts/attestations.md)
* [Hypercerts & Impact Tokens (Roadmap)](concepts/hypercerts.md)

## Product Features

* [Product Overview](features/overview.md)
...
* [Using Attestation & Hypercerts Data](guides/evaluators/using-attestation-data.md)
* [Integrating with External Frameworks](guides/evaluators/external-frameworks.md)

### Examples & Recipes

* [Overview](guides/examples/README.md)
* [GraphQL Recipes](guides/examples/graphql-recipes.md)
* [Integration Snippets](guides/examples/integration-snippets.md)

## Developer Documentation

### Getting Started

* [Overview for Builders](developer/getting-started.md)
* [Installation & Environment Setup](developer/installation.md)
...
* [Design & Research](reference/design-research.md)
* [Credits & Licenses](reference/credits.md)
* [Gardener Hub](reference/for-gardeners.md)
* [Operator Hub](reference/for-operators.md)
* [Evaluator & Funder Hub](reference/for-evaluators.md)
* [Contributing to Documentation](reference/docs-contributing.md)
