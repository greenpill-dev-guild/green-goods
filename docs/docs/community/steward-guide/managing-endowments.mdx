...
slug: /community/steward-guide/managing-endowments
audience: steward
owner: docs
last_verified: 2026-07-03
feature_status: Live
goal: "Guide stewards through the current live vault workflow, with honest notes about chain availability and role boundaries."
difficulty: "standard"
...
<FeatureState
  title="Steward UI"
  status="Live"
  summary="Vault and endowment surfaces are live in admin. What a steward can do depends on wallet permissions, selected chain, and the vaults configured for that garden."
/>

<FeatureState
  title="Chain readiness"
  status="Live"
  summary="Vaults are live on Arbitrum, where Season One gardens run. If your garden is on a different network, check with the team before planning deposits."
/>
