...
slug: /community/steward-guide/earning-recognition
audience: all
owner: docs
last_verified: 2026-03-01
feature_status: Live
goal: "Help stewards understand how their garden management builds on-chain reputation and community recognition."
difficulty: "standard"
estimated_time: "5 minutes."
prereqs: "Active management of at least one garden."
next_steps: "/community/how-it-works"
persona_context: "Stewards building reputation through consistent, high-quality garden management."
source_of_truth:
...
- **Attestation history** — the cumulative on-chain record of all your steward actions

<FeatureState
  title="Formal reputation scoring"
  status="Planned"
  summary="Structured reputation metrics and visual badges for stewards are planned for a future release. Current recognition is based on raw attestation history."
/>

## Best Practices

- Maintain a regular review cadence — gardens with responsive stewards attract and retain more gardeners
...
- Share your attestation history when applying for grants or new steward roles — it serves as a verifiable resume
...
<NextBestAction
  ...
  alternatives={[
    {label: "Managing Certificates", href: "/community/steward-guide/managing-certificates"},
    {label: "Managing Payouts", href: "/community/steward-guide/managing-payouts"},
  ]}
/>
