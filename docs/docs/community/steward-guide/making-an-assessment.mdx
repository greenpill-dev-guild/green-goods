...
slug: /community/steward-guide/making-an-assessment
...
goal: "Walk a steward or evaluator through the three-step assessment form."
difficulty: "standard"
...
persona_context: "Stewards and evaluators recording the context that later approvals and impact certificates should support."
source_of_truth:
...
<GuideOpener
  image="/img/social/making-an-assessment.webp"
  alt="Stewards setting a garden's assessment baseline — diagnosis, outcomes, and actions"
...
Create an assessment for a garden. An assessment records the domain, title, location, reporting window, outcomes, selected actions, metrics, and context that stewards will use when they review work and later mint impact certificates.

Assessments are steward-first, but the permission is broader: garden owners, stewards, and evaluators can create them. Approving or rejecting work is still owner/steward only.
...
- You are signed in as a garden **owner**, **steward**, or **evaluator**.
...
- **No permission.** Ask the garden owner to add you as an owner, steward, or evaluator.
