...
slug: /community/steward-guide/managing-certificates
audience: all
owner: docs
last_verified: 2026-07-03
feature_status: Live
goal: "Help stewards manage hypercert lifecycle, track work quality, and maintain certificate integrity."
difficulty: "standard"
estimated_time: "15-25 minutes."
prereqs: "Active garden with approved work and minted hypercerts."
next_steps: "/community/steward-guide/earning-recognition"
persona_context: "Stewards managing the hypercert lifecycle from minting through listing and trade monitoring."
source_of_truth:
...
<FeatureState
  ...
  status="Live"
  summary="Detail views, listing tables, and trade history are live, and the marketplace contracts (adapter, exchange, and fraction-offer strategy) are deployed on Arbitrum."
/>
...
- If you need to cancel a listing, use the cancel flow in the admin Hypercert detail surface rather than letting it expire

## What's Next

<NextBestAction
  title="Next best action"
  why="With certificates managed, understand how your steward work builds reputation."
  actionLabel="Earning Recognition"
  actionHref="/community/steward-guide/earning-recognition"
  alternatives={[
    {label: "Managing Payouts", href: "/community/steward-guide/managing-payouts"},
    {label: "Mint Hypercerts (detailed)", href: "/community/steward-guide/creating-impact-certificates"},
  ]}
/>
