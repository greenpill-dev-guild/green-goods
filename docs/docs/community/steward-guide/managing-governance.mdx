...
slug: /community/steward-guide/managing-governance
audience: steward
owner: docs
last_verified: 2026-07-03
feature_status: Live
goal: "Explain the current governance flow without outdated 'pending deployment' language."
difficulty: "standard"
estimated_time: "20-40 minutes for setup and first pass."
...
<FeatureState
  ...
  status="Live"
  summary="Strategy and signal-pool routes are live in admin and supported by conviction hooks in shared."
/>

<FeatureState
  title="Chain readiness"
  status="In progress"
  summary="The governance module is deployed on Arbitrum, but creating a signal pool also needs an initialized community and pool configuration that are not in place for every garden yet. Check with the team before planning a pool on any network."
/>
...
<DecisionGuide
  ...
  items={[
    ...
    },
    {
      ...
      do: "Use cookie jars or steward-approved endowment actions.",
