...
- **Track real impact** — Every claim is backed by EAS attestations verified by community stewards
...
Every piece of funded work has a verifiable chain: **Gardener submission → Steward approval → Evaluator assessment → Hypercert**. Each step creates an on-chain attestation you can independently verify.
