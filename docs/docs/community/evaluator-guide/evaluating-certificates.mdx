...
<StepFlow
  steps={[
    ...
    {title: "Verify attestation chains", detail: "For each piece of work included in the hypercert, confirm the attestation chain is intact: work submission UID exists, approval refUID matches, attester is an authorized steward, and no attestations are revoked."},
...
<DecisionGuide
  ...
  items={[
    ...
    },
    {
      ...
      next: "Report findings to the garden steward and note caveats in evaluation reports.",
    },
    {
...
- Consider the garden's review standards and steward history when assessing evidence quality — well-run gardens typically produce more reliable attestation chains
