...
- **Upload when you're ready** – When you come back online, the app gets queued work ready in the background, and one tap on **Upload all** in **Your Work** sends all of it with a single signature.
