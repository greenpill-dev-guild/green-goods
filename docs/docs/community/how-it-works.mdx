...
Green Goods is built for the reality of field work, including **intermittent connectivity**, **mid-range devices**, and **diverse languages**. Everything works locally first, then syncs when conditions allow.

### Privacy & Security

Your data stays on your device until you choose to submit. Green Goods uses **passkey authentication** tied to your device's secure enclave, and your biometric data never leaves your phone. Behind the scenes, a **smart account** is created for you using account abstraction, giving you a secure community account without exposing private keys.
...
All methods provide:
- **Automatic smart account**: A secure community account is created for you, regardless of how you sign in.
- **Gasless transactions**: Work submissions are bundled and sponsored, so you never need to buy tokens or pay gas fees.
- **Minutes, not hours**: From first visit to first submission, the onboarding flow takes just minutes.
...
3. **Evaluators** assess and certify → creates impact assessments
