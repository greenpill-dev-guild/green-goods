...
Every submission becomes a verifiable on-chain record when it reaches the network — immediately online, or as soon as offline work syncs. Operator approval adds a second, linked record — together they build into a complete impact story.
...
2. **Operators** review and approve → a separate approval attestation links to the work
3. **Evaluators** author assessments that frame and score impact → **Operators** create Hypercerts
