...
Every submission becomes a verifiable on-chain record the moment it is sent; operator approval adds a second, linked record — together they build into a complete impact story.
...
1. **Gardeners** document work → each submission is an on-chain attestation immediately
