...
```mermaid
graph TD
    N["Natural Capital\nEcosystem health, biodiversity"] --- S["Social Capital\nCommunity bonds, trust"]
    S --- F["Financial Capital\nEconomic value, costs saved"]
    F --- M["Material Capital\nInfrastructure created"]
    M --- L["Living Capital\nFood, species, health"]
    L --- I["Intellectual Capital\nKnowledge, research, data"]
    I --- E["Experiential Capital\nSkills, practices learned"]
    E --- SC["Spiritual/Cultural Capital\nConnection to land, purpose"]
    SC --- N
