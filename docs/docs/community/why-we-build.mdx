...
The relationship between humans and nature is richer than any single metric. Green Goods captures this through the Eight Forms of Capital framework, described below.

---

## Eight Forms of Capital

Green Goods measures impact across the **Eight Forms of Capital** -- a holistic framework that recognizes regenerative work produces value far beyond financial returns. The forms listed below are examples, not an exhaustive taxonomy; communities may identify additional dimensions of value specific to their bioregion and culture.

{/* TODO: add Gitcoin/Hypercerts imagery for Forms of Capital */}

```mermaid
graph TD
    N["Natural Capital<br/>(e.g. ecosystem health, biodiversity)"] --- S["Social Capital<br/>(e.g. community bonds, trust)"]
    S --- F["Financial Capital<br/>(e.g. economic value, costs saved)"]
    F --- M["Material Capital<br/>(e.g. infrastructure created)"]
    M --- L["Living Capital<br/>(e.g. food, species, health)"]
    L --- I["Intellectual Capital<br/>(e.g. knowledge, research, data)"]
    I --- E["Experiential Capital<br/>(e.g. skills, practices learned)"]
    E --- SC["Spiritual/Cultural Capital<br/>(e.g. connection to land, purpose)"]
    SC --- N
...
Green Goods supports **20+ active garden communities** across Latin America, Africa, and North America. Here are some of the communities we build for.

{/* TODO: replace # with actual garden project URLs */}

**University of Nigeria Nsukka -- Solar Infrastructure** -- Students and staff monitor and maintain solar panels that provide critical power to campus facilities. Green Goods' **offline-first design** is essential here -- submissions happen in areas with limited connectivity and sync when WiFi is available. [View their impact -->](#)

**Cape Town -- Waste Management with Sarafu** -- Waste collectors in Cape Town earn **Sarafu mutual credits** for verified waste collection and sorting. Multi-language support enables collectors to work in their preferred language. [View their impact -->](#)

**AgroforestryDAO Brasil -- Agroforestry & DeSci** -- Brazilian agroforestry practitioners combine fieldwork with **decentralized science** data partnerships. Portuguese language support is critical for this community. [View their impact -->](#)

**Uganda -- School-Tree-Student Program** -- Students adopt and monitor trees as part of their curriculum, learning ecological stewardship while generating **verifiable impact data**. The mobile-first, low-bandwidth design ensures the app works on mid-range Android devices. [View their impact -->](#)
