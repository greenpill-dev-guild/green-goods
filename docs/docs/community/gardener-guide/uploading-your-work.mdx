...
next_steps: "/community/operator-guide/reviewing-work"
...
- You've already joined a garden. If you haven't, open the garden and tap **Join** before coming back.
...
Your submission becomes an on-chain **work attestation** once it's uploaded. When an operator approves it, a second attestation links their review decision back to your work. That pair is what assessments and Hypercerts reference later.
...
<NextBestAction
  title="Wait for your operator to approve it"
  why="Once you've submitted, an operator picks up the work from the queue and approves or rejects it. That's the next link in the chain."
  actionLabel="Approve Work (for operators)"
  actionHref="/community/operator-guide/reviewing-work"
  alternatives={[
