...
<FeatureState
  ...
  status="Live"
  summary="Current Arbitrum and Sepolia deployment artifacts include non-zero governance module addresses. Verify the selected chain before assuming the same on every network."
/>
