...
<FeatureState
  ...
  status="Live"
  summary="Governance modules are live on Arbitrum, where Season One gardens run. If your garden is on a different network, check with the team before configuring pools."
/>
