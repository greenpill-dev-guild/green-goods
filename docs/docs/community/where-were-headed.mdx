...
source_of_truth:
  ...
  - docs/docs/builders/specs/revenue-explorer.mdx
...
If you want to test the funding assumptions behind this strategy, the builder docs include a [Protocol Revenue Explorer](/builders/specs/revenue-explorer) that models fees, TVL, Hypercert volume, treasury yield, and grants/contracts in one place.
