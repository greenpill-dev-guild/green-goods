...
Assessments in Green Goods are framed using the **Eight Forms of Capital** - measuring impact beyond financial value alone. The following are examples of what each form tracks; communities may define additional indicators relevant to their context:

| Capital Form | What It Measures (e.g.) |
|-------------|-----------------|
...
### Yield Generating Funding

The **Octant Vault** system creates a sustainable funding flow:
...
3. **Harvest** routes yield three ways: Cookie Jar (operational funds), Hypercert fractions (impact investment), and community endowment
