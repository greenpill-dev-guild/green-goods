...
**Best Practices**:
- ✅ Natural daylight (mid-morning or late afternoon)
- ✅ Overcast days (even lighting, no harsh shadows)
- ✅ Clean camera lens
- ✅ Steady hands (or use timer)
- ✅ Multiple angles for complex work
...
**Avoid**:
- ❌ Rounding excessively (15 → "about 20")
...
**Do Instead**:
- ✅ Count carefully
- ✅ Note if estimation (e.g., "~50 estimated")
- ✅ Be conservative if unsure
- ✅ Explain methodology in notes
...
**Include in Notes**:
- Extreme conditions ("100°F heat, extra water needed")
...
**Example Series**:
```
Mar 2024: Planted 20 oak seedlings
Jun 2024: All 20 thriving, 30cm growth
Sep 2024: 18 surviving, deer protection added
Mar 2025: 17 healthy trees, 1m tall
```
...
- [ ] Photos are clear and show before/after?
- [ ] Metrics are counted accurately?
- [ ] Location is correct?
- [ ] Context explains any unusual conditions?
- [ ] Action selection matches work done?
- [ ] All required fields completed?
- [ ] Proofread for spelling/clarity?
- [ ] Ready to stand by this submission?

**If all ✅**: Submit with confidence!
**If any ❌**: Improve before submitting.
