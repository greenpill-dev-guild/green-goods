...
<!-- TODO: Add image - Admin Dashboard Login -->
...
**Note**: Only admins can create new gardens. If you're an operator (not admin), skip to [Step 4: Review Work](#step-4-review-work-submissions).
...
<!-- TODO: Add image - Create Garden Modal -->
...
<!-- TODO: Add image - Create Action Modal -->
...
<!-- TODO: Add image - Pending Work List -->
...
<!-- TODO: Add image - Work Review Detail -->
...
<!-- TODO: Add image - Approval Confirmation -->
...
<!-- TODO: Add image - Garden Dashboard -->
...
- 📖 **Admin README**: [packages/admin/README.md](https://github.com/greenpill-dev-guild/green-goods/tree/main/packages/admin#readme)
