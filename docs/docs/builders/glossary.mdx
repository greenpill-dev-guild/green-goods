...
### Celo
A carbon-negative blockchain focused on mobile-first financial tools and regenerative finance. Green Goods production runs on Arbitrum One; a Celo deployment exists, and Celo is the planned mint chain for GreenWill badges, with qualifying source activity coming from Celo or Arbitrum.
