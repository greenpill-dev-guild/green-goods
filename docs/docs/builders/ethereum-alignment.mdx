...
- Planned companion essay: "CROPS and Regeneration" — how censorship resistance, open source, privacy, and security serve environmental communities.
- Planned companion essay: "The Walkaway Test for Impact Platforms" — what happens when the platform disappears.
...
<NextBestAction
  ...
  alternatives={[
    { label: "Integrations", href: "/builders/integrations/overview" },
