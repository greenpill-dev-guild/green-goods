...
source_digest: "sha256:2c73096ef80f67dd0ae7d632216dd872425117ae486e3e5eecb6e3bc99deb796"
source_of_truth:
  - packages/shared/src/ontology/green-goods-ontology.json
  - scripts/quality/check-ontology.mjs
  - scripts/quality/ontology-render.mjs
...
- **Rows** are grouped as entities, schemas, personas, or integration-facing concepts.
...
| Green Goods | Karma GAP | Hypercerts | Octant | Gardens V2 | Hats Protocol | Silvi | Cookie Jar | Unlock | ENS | Lido | FTC |
|---|---|---|---|---|---|---|---|---|---|---|---|
| Garden Steward | Project Owner | Creator | Vault Admin, TAM Operator | Council Member | Steward Hat | — | — | — | — | — | — |
...
<NextBestAction
  ...
  actionHref="/builders/integrations"
  alternatives={[
    {label: "EAS integration", href: "/builders/integrations/eas"},
  ]}
/>
