...
| `RESEND_API_KEY` | Server-side Resend key used by the agent public subscribe route. Not embedded in browser bundles. |
| `RESEND_GREEN_GOODS_SEGMENT_ID` | Resend segment ID for public Green Goods subscribers. |
| `RESEND_GREEN_GOODS_TOPIC_ID` | Resend topic ID for public Green Goods subscribers. |
