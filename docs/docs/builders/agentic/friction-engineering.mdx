...
1. **Stable entry points**
   ...
   - shared imports should use declared public export paths, never source internals
...
- `scripts/harness/plan-hub.mjs` and its black-box tests enforce deterministic plan structure, lifecycle transitions, and closeout metadata
