...
The project keeps 12 skills -- `review`, `module-seams-review`, `ship`, `plan`, `research`, `debug`,
`clean`, `audit`, `qa-triage`, `doc-feedback`, `design`, and `resolve-pr-comments` -- reserved for
