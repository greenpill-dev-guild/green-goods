...
```
.claude/
  skills/           # 12 skills -- the filesystem + SKILL.md frontmatter is the registry
...
Five skills are user-invocable slash commands advertised in the session banner
(`/review /audit /clean /qa-triage /doc-feedback`); other skills load from their declared triggers or
