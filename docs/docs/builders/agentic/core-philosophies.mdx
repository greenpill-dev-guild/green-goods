...
- **Agent specs** in `.claude/agents/` define the two committed specialist roles: read-only research (`oracle`) and TDD implementation (`cracked-coder`). Review, migration, triage, and documentation work route through skills and workflow prompts.
