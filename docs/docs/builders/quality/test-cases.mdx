...
source_digest: "sha256:e56f2e66dcf59123d2b48a280a6742e1981dfebceea07a1b8fc05e18846c2fcb"
source_of_truth:
  - package.json
  - packages/admin/vitest.config.ts
  - packages/agent/vitest.config.ts
...
| `XPLAT-003` | Cross Surface · Network/media failures degrade gracefully | 2026-08-29 | Cross Surface dissolved in catalog v2; replaced by per-surface error-recovery rows | `PUB-008`, `PWA-040`, `ADM-032` |
...
| `XPLAT-006` | Cross Surface · Light and dark themes keep every control legible | 2026-08-29 | Cross Surface dissolved in catalog v2; theme legibility is covered per surface | `PUB-025`, `DOCS-006` |
