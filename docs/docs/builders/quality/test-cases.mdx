...
`scripts/data/qa-test-catalog.json` versions the scenario definitions (63 cases across Public
Website, PWA iOS, PWA Android, Admin Dashboard, Cross Surface, and Docs), and
