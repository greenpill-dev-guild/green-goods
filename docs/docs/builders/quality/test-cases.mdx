...
source_digest: "sha256:ab69b0e72a4c3b3a4eebf9b763df2e817746db235e4c468950d32241791f3022"
source_of_truth:
  - package.json
  - packages/admin/vitest.config.ts
  - packages/agent/vitest.config.ts
...
| `PWA-051` | Resilience | Offline Startup | First-load connectivity loss: accurate offline state and automatic reconnect recovery | Offline and recovered screenshots, failed request, reload count, and authentication/local-data continuity note |
...
### P0 — run these first (23) {#admin-dashboard-p0}
