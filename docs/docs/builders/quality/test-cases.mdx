...
`scripts/data/qa-test-catalog.json` versions the scenario definitions across Public
Website, PWA iOS, PWA Android, Admin Dashboard, Cross Surface, and Docs (the catalog itself is
