...
source_digest: "sha256:f2e6b0bf510b38743a4b79f802909aac693fd386228e501ce3dd6c806b409b34"
source_of_truth:
  - package.json
  - packages/admin/vitest.config.ts
  - packages/agent/vitest.config.ts
...
| `DOCS-011` | Content & vocabulary | Builder Docs | Builder onboarding path: getting-started commands (including environment setup) run on a fresh checkout | Terminal transcript |
