...
generated_from:
  ...
  - package.json
source_digest: "sha256:45fc2a9d6f3dfcb0d94c0cd5b3bb163afbb0c5482de03babb5e2458cfdc3edcd"
source_of_truth:
  - .github/workflows/admin.yml
  - .github/workflows/agent.yml
  - .github/workflows/ci-gate.yml
...
| Supply Chain Guardrails | `.github/workflows/supply-chain-guardrails.yml` | `audit`, `guidance` |
