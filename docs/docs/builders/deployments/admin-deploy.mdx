...
The admin dashboard is a Vite + React SPA for garden stewards. It shares the same build toolchain and dependency chain as the client but targets desktop browsers and does not include service worker or offline-first capabilities.
...
- **Steward** -- Can create/manage gardens, actions, and assessments
