...
The admin dashboard is **wallet-only**. Email and social login are disabled in the admin AppKit configuration. Stewards and stewards are expected to have existing wallets.
