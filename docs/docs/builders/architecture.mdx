...
| Project | What it adds | Integration point |
| --- | --- | --- |
| **[Coop](https://coop.town)** | Browser-first knowledge capture, local AI refinement, group memory | `Roost` workspace embeds Green Goods member flows; evidence packaging feeds Hypercerts |
| **[WEFA](https://wefa.app)** | Gamified plant care and nature education | Plant verification creates attestation-grade nurture evidence; energy economy maps to impact |

All three share passkey-first identity, ERC-4337 smart accounts, offline-first architecture, and EAS attestations on Arbitrum. See the [Agent package docs](./packages/agent) for details on how the projects connect.
