...
- Use `WorkbenchCard` for workbench records, action queue items, assessment queue items, and other records stewards scan, compare, and act on in a grid or list.
