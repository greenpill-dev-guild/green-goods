...
source_of_truth:
  ...
  - docs/docs/builders/specs/v1-0.mdx (§ 1.5, § 6.3)
...
| 13 | Publish Season record | B | (not built) | Public Season read shape is planned; no publish mutation exists | The write path (operator declares Season N closed → Season record materialized) is not in the codebase | aspirational |
