...
source_of_truth:
  ...
  - packages/shared/src/hooks/roles
...
v0.4 is complete and kept for historical context. v1 is the current active specification.
:::
...
- **Garden Stewards** — Key users and contributors to data collection and impact tracking
...
- Difficulty in engaging volunteers and stewards in a proactive, growth-oriented manner
...
As a **Gardener**, I want to view actions created by stewards:
...
Same core stack as v0.1 (Privy + Pimlico, PWA, EAS, and tokenbound accounts) with the following additions.
...
- **Garden Stewards** — Create and manage actions and attest to completion
...
| Interface for Approving Work | Steward approval flows |
...
| Quarter | Focus |
|---------|-------|
| **Q4 2024** | Simple MVP for gardeners and stewards to create actions and perform work |
...
Green Goods v0.4 moved the earlier biodiversity reporting loop toward a more complete passkey-first stack: field evidence, EAS attestations, tokenbound accounts, Karma reporting, and Hypercert-oriented recognition. The builder takeaway is that each user-facing workflow should stay grounded in simple capture and review steps while preserving the on-chain evidence needed for later funding and reputation surfaces.
