...
sidebar_position: 3
slug: /developers/build-patterns
audience: developer
owner: docs
...
<AtAGlanceCard
  ...
  prereqs="Basic repo familiarity."
  outcome="Changes follow project conventions and remain easy to maintain."
...
<NextBestAction
  ...
  alternatives={[
    ...
    {label: "Developer reference", href: "./reference"},
  ]}
/>
