...
> **Related docs:** [Monorepo Structure](monorepo-structure.md), [packages/client/README.md](https://github.com/greenpill-dev-guild/green-goods/tree/main/packages/client#readme)
