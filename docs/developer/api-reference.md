...
> Need quick copy/paste snippets? See [GraphQL Recipes](../guides/examples/graphql-recipes.md) and [Integration Snippets](../guides/examples/integration-snippets.md).
