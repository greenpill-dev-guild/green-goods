...
[Learn more about why Green Goods →](welcome/why-green-goods.md)
...
[**Gardener Quickstart →**](welcome/quickstart-gardener.md) • [Gardener Hub](reference/for-gardeners.md)
...
[**Operator Quickstart →**](welcome/quickstart-operator.md) • [Operator Hub](reference/for-operators.md)
...
[**Evaluator Quickstart →**](welcome/quickstart-evaluator.md) • [Evaluator Hub](reference/for-evaluators.md)
...
[See all use cases →](welcome/what-you-can-do.md)
...
<table>
  <tr>
    <td align="center" width="25%">
      <h3>🌱</h3>
      <a href="welcome/quickstart-gardener.md"><strong>I want to document work</strong></a><br>
      <small>Start submitting impact in 5 minutes</small>
    </td>
    <td align="center" width="25%">
      <h3>🧑‍🌾</h3>
      <a href="welcome/quickstart-operator.md"><strong>I want to manage a garden</strong></a><br>
      <small>Create your community hub</small>
    </td>
    <td align="center" width="25%">
      <h3>📊</h3>
      <a href="welcome/quickstart-evaluator.md"><strong>I want to analyze impact</strong></a><br>
      <small>Access verified data</small>
    </td>
    <td align="center" width="25%">
      <h3>👩‍💻</h3>
      <a href="welcome/quickstart-developer.md"><strong>I want to build</strong></a><br>
...
- [Core Concepts](concepts/roles.md) — Understand gardens, actions, work, and attestations
- [Product Features](features/overview.md) — Explore what makes Green Goods unique
- [How-To Guides](guides/gardeners/logging-work.md) — Step-by-step tutorials for all roles
- [Developer Docs](developer/getting-started.md) — Technical documentation and APIs
