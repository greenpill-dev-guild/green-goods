...
- For ambiguous, multi-package, or high-risk work, separate research, plan, and implementation. Record source evidence, open assumptions, and human judgment points before recommending edits.
