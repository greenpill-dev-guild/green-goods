...
test.describe("Offline Sync Flows", () => {
  // SKIP: #338 owner:afo expiry:2026-10-16 — needs real auth infrastructure
  test.skip(
    () => true,
  ...
  test.describe("Work Queuing", () => {
    test("queues work submission when offline", async ({ page, context }) => {
      ...
      // SKIP: #338 owner:afo expiry:2026-10-16 — runtime data availability check
  ...
  test.describe("Conflict Resolution", () => {
    test("detects duplicate submission conflict", async ({ page }) => {
      ...
      // SKIP: #338 owner:afo expiry:2026-10-16 — needs pre-existing duplicate work
      test.skip(
        true,
    ...
    test("shows conflict resolution UI", async ({ page }) => {
      ...
      // SKIP: #338 owner:afo expiry:2026-10-16 — needs simulated duplicate
    ...
    test("resolves conflict by skipping duplicate", async ({ page }) => {
      ...
      // SKIP: #338 owner:afo expiry:2026-10-16 — needs active conflict state
  ...
  test.describe("Storage Management", () => {
    ...
    test("warns when storage is nearly full", async ({ page }) => {
      ...
      // SKIP: #338 owner:afo expiry:2026-10-16 — needs filled local storage
      test.skip(
        true,
