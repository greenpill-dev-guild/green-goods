# Storybook Addons & Design System Documentation

> Sub-file of the [ui skill](./SKILL.md). Addon configuration (a11y, themes, interactions) and design system documentation patterns (MDX pages, component API docs, story organization).
...
**Every component MUST pass a11y checks** -- this is enforced by the compliance checklist.
