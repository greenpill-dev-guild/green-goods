...
**Critical**: teammates do NOT inherit the lead's conversation history. They need the applicable AGENTS.md and project context, but task-specific details must be in the spawn prompt.
