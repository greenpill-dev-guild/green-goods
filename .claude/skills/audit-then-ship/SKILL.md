...
1. Make the edit.
2. **Verify the change in the same turn**: re-read the file, run the targeted test, or read the rendered DOM (Chrome MCP) for UI changes. No "should work" claims. (See CLAUDE.md → *Verify Before Claiming Success*.)
3. Move to the next.
