...
- [Green Goods Defaults](#green-goods-defaults)
- [v5 Critical Changes](#v5-critical-changes)
- [Query Patterns](#green-goods-query-patterns)
- [Mutations](#mutations-with-invalidation)
- [Optimistic Updates](#optimistic-updates)
- [Dependent & Parallel Queries](#dependent-queries)
- [Infinite Queries](#infinite-queries)
- [Error Handling](#error-handling)
- [Configuration](#configuration)
- [GraphQL Integration](#graphql-integration-with-graphql-request)
- [Virtualizing Large Lists](#virtualizing-large-lists)
