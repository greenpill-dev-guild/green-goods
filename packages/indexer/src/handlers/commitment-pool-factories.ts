...
export function createPool(chainId: number, poolId: bigint, timestamp: number): CommitmentPool {
  return {
    ...
    pauseReasonBlockNumber: undefined,
    pauseReasonLogIndex: undefined,
    openSeasonCycleId: undefined,
    openSeasonCycleEntityId: undefined,
    openSeasonBlockNumber: undefined,
    openSeasonLogIndex: undefined,
    openCampaignIds: [],
...
export function createContributor(
  ...
  return {
    ...
    removalBlockNumber: undefined,
    removalLogIndex: undefined,
    addedBy: undefined,
    addedAt: undefined,
    removedBy: undefined,
    removedAt: undefined,
