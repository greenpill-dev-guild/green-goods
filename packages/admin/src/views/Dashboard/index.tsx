          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-yellow-700">
                ...
                <p className="mt-1">The dashboard will work with limited functionality. Garden operations are still available.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <>
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Total Operators</p>
                  <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{totalOperators}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Total Gardeners</p>
                  <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{totalGardeners}</p>
                </div>
              </div>
            </div>
          </>
