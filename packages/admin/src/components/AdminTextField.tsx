      ...
      return (
        <div className={cn("flex flex-col", className)}>
          ...
          >
            ...
            <label
              ...
              className={cn(
                ...
                "duration-[var(--spring-fast-duration,200ms)] ease-[var(--spring-fast-easing,cubic-bezier(0.34,1.56,0.64,1))]",
                // Resting state
                isFloating
                  ? [
          ...
          <div
            aria-hidden="true"
            className={cn(
              "w-full transition-all duration-[var(--spring-fast-duration,200ms)]",
              hasError
