        ...
        <div className="w-full max-w-3xl rounded-2xl bg-white shadow-xl">
          <div className="flex items-center justify-between border-b border-gray-100 px-6 py-4">
            <div>
              ...
              <p className="text-sm text-gray-500">Guide your community through a streamlined garden launch flow.</p>
            </div>
            <button
              onClick={closeModal}
              ...
              {steps.map((step, index) => {
                ...
                return (
                  <li key={step.id} className="flex flex-1 items-center gap-3">
                    ...
                    {index < steps.length - 1 && <span className="ml-auto h-px flex-1 bg-gray-200" />}
                  </li>
                );
              })}
            </ol>
          ...
          <div className="space-y-6 px-6 py-6">
            {hasError && (
              <div className="flex items-start gap-3 rounded-lg border border-red-100 bg-red-50 p-4 text-sm text-red-700">
                ...
                <div>
                  ...
                  <p className="mt-1 text-red-600">{state.context.error ?? "Please review the details and try again."}</p>
            ...
            {isSuccess ? (
              <div className="space-y-6 text-center">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900">Garden deployment submitted</h3>
                  <p className="mt-2 text-sm text-gray-600">
                    The transaction hash is <span className="font-mono text-xs">{state.context.txHash}</span>. Share the
                ...
                {isDetailsStep && (
                  <div className="space-y-5">
                    <section>
                      ...
                      <p className="text-sm text-gray-500">Tell us where the garden lives and how to describe it.</p>
                    </section>
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                      <label className="space-y-1 text-sm">
                        ...
                        <input
                          ...
                          className={cn(
                            ...
                            showDetailsErrors && detailsErrors.name && "border-red-300 focus:border-red-400 focus:ring-red-100"
                          )}
                        />
                      ...
                      <label className="space-y-1 text-sm">
                        ...
                        <input
                          ...
                          className={cn(
                            "w-full rounded-md border px-3 py-2 text-sm shadow-sm focus:border-green-500 focus:outline-none focus:ring-2 focus:ring-green-200",
                            showDetailsErrors && detailsErrors.location && "border-red-300 focus:border-red-400 focus:ring-red-100"
                          )}
                        />
                    ...
                    <label className="space-y-1 text-sm">
                      ...
                      <textarea
                        ...
                        className={cn(
                          "w-full rounded-md border px-3 py-2 text-sm shadow-sm focus:border-green-500 focus:outline-none focus:ring-2 focus:ring-green-200",
                          showDetailsErrors && detailsErrors.description && "border-red-300 focus:border-red-400 focus:ring-red-100"
                        )}
                      />
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                      <label className="space-y-1 text-sm">
                        ...
                        />
                        <span className="text-xs text-gray-500">Must match the ERC-20 token powering the community.</span>
                        {showDetailsErrors && detailsErrors.communityToken && (
                          <span className="text-xs text-red-600">{detailsErrors.communityToken}</span>
                        )}
                      </label>
                      <label className="space-y-1 text-sm">
                        ...
                        />
                        <span className="text-xs text-gray-500">Optional link to a hero image showcasing the garden.</span>
                      </label>
                    </div>
                  </div>
                )}
                  ...
                  <div className="space-y-5">
                    <section>
                      ...
                      <p className="text-sm text-gray-500">
                        Add wallets that can tend to the garden and coordinate future work. Gardeners mint attestations and
                        operators oversee approvals.
                      </p>
                    </section>

                    <div className="space-y-4">
                      <div>
                        <label className="mb-2 block text-sm font-medium text-gray-700">Gardeners *</label>
                        ...
                        {gardenerError && <p className="mt-1 text-xs text-red-600">{gardenerError}</p>}
                        {showTeamErrors && teamError && <p className="mt-1 text-xs text-red-600">{teamError}</p>}
                      ...
                      <div>
                        <label className="mb-2 block text-sm font-medium text-gray-700">Garden operators</label>
                        <div className="flex items-center gap-2">
                          <input
                            value={operatorInput}
                        ...
                        {operatorError && <p className="mt-1 text-xs text-red-600">{operatorError}</p>}
                        <ul className="mt-3 space-y-2">
                ...
                {isReviewStep && (
                  <div className="space-y-5">
                    ...
                    <div className="space-y-4 rounded-xl border border-gray-100 bg-gray-50 p-4">
                      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div>
                          <h4 className="text-xs font-semibold uppercase tracking-wide text-gray-500">Garden name</h4>
                          <p className="mt-1 text-sm text-gray-900">{form.name}</p>
                        </div>
                        <div>
                          <h4 className="text-xs font-semibold uppercase tracking-wide text-gray-500">Location</h4>
                        ...
                        <div>
                          <h4 className="text-xs font-semibold uppercase tracking-wide text-gray-500">Community token</h4>
                          <p className="mt-1 font-mono text-xs text-gray-900">{form.communityToken}</p>
                        ...
                        {form.bannerImage && (
                          <div>
                            <h4 className="text-xs font-semibold uppercase tracking-wide text-gray-500">Banner image</h4>
                            <p className="mt-1 break-words text-sm text-gray-900">{form.bannerImage}</p>
                          </div>
                        )}
                      </div>
                      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div>
                          <h4 className="text-xs font-semibold uppercase tracking-wide text-gray-500">Gardeners</h4>
                        ...
                        <div>
                          <h4 className="text-xs font-semibold uppercase tracking-wide text-gray-500">Operators</h4>
          ...
          {!isSuccess && (
            <div className="flex flex-wrap items-center justify-between gap-3 border-t border-gray-100 bg-gray-50 px-6 py-4">
              <div>
                {isDetailsStep && <p className="text-xs text-gray-500">Step 1 of 3 · Provide foundational garden info.</p>}
                {isTeamStep && <p className="text-xs text-gray-500">Step 2 of 3 · Invite gardeners and optional operators.</p>}
                {isReviewStep && <p className="text-xs text-gray-500">Step 3 of 3 · Review details before deploying.</p>}
              </div>
