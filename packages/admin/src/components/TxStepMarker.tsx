...
export type TxStepMarkerState = "pending" | "active" | "complete" | "failed" | "warning";
 ...
 * spinner while it runs, a check once the chain shows it, a cross where it
 * stopped. One atom for every multi-step signature surface (minting a
 * hypercert, setting up a pool), so a steward reads progress the same way
 * everywhere. Decorative: the step's own text carries its state for screen
 * readers.
 */
