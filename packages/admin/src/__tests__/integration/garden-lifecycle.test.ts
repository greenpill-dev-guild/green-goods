...
describe.skipIf(!isIntegrationEnabled)("Garden Lifecycle Integration Tests", () => {
  ...
  beforeAll(async () => {
    ...
    deploymentRegistryAddress =
      process.env.VITE_DEPLOYMENT_REGISTRY_ADDRESS || "0x1234567890123456789012345678901234567890";
  });
  ...
  it("should fail when unauthorized user tries to perform admin actions", async () => {
    ...
    const unauthorizedKey =
      "0x9876543210987654321098765432109876543210987654321098765432109876" as const;
