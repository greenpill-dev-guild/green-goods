...
- For local human/agent browser walkthroughs of shared UI, prefer Brave with an
  isolated/non-default profile; keep Storybook and repo proof commands Chrome/Chromium-compatible
