...
// The react-spring `SPRING_CONFIGS` token map was removed when the canvas moved
// to CSS transitions. What survives here are the two tuning constants for the
// drag-dismiss gesture and the choreography stagger.
