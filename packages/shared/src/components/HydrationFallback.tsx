  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-3 text-center">
        {showIcon && (
          <div className="mx-auto h-16 w-16 bg-success-lighter rounded-xl flex items-center justify-center mb-1 animate-pulse">
            <svg className="h-10 w-10 text-success-base" fill="currentColor" viewBox="0 0 20 20">
              <path
                fillRule="evenodd"
