...
export function mapCommitment(row: RawRow): CommitmentReadModel {
  ...
  const mapped: CommitmentReadModel = {
    ...
    considerationToken: address(row.considerationToken),
    ...
    readyOverridden: row.readyOverridden === true,
    preDisputeState: string(row.preDisputeState) as CommitmentReadModel["preDisputeState"],
    disputeReasonCID: string(row.disputeReasonCID),
    cancelReasonCID: string(row.cancelReasonCID),
