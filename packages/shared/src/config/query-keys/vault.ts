...
export const cookieJarKeys = {
  ...
  campaigns: (chainId: number) => ["greengoods", "cookieJar", "campaigns", chainId] as const,
...
export const yieldKeys = {
  ...
  wiring: (gardenAddress: string, chainId: number) =>
    ["greengoods", "yield", "wiring", gardenAddress, chainId] as const,
