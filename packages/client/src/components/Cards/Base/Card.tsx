...
export const cardVariants = tv({
  ...
  variants: {
    ...
    animating: {
      default:
        "active:brightness-102 active:bg-primary/1.5 transition-[background-color,filter,box-shadow,transform] duration-[var(--spring-spatial-fast-duration)] ease-[var(--spring-spatial-fast-easing)]",
      none: "",
    },
  },
  defaultVariants: {
