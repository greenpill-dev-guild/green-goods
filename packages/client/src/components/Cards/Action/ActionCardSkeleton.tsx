...
export const ActionCardSkeleton: React.FC<ActionCardSkeletonProps> = ({
  ...
  return (
    <Card className={cn(classes)}>
      ...
      <div className="flex flex-1 flex-col gap-2 rounded-b-lg border border-t-0 border-border p-3 transition-all duration-[var(--spring-spatial-duration)] ease-[var(--spring-spatial-easing)] @[300px]:p-4 @[400px]:p-5">
