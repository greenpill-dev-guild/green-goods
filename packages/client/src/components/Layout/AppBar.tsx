    ...
    <>
      ...
      <nav
        ...
        className={cn(
          ...
          "fixed bottom-0 bg-bg-white-0 border-t border-t-stroke-soft-200 flex flex-row justify-evenly items-center w-full pt-2 pb-[calc(0.25rem+env(safe-area-inset-bottom))] z-40 transition-transform duration-300",
          shouldHideBar ? "translate-y-full" : "translate-y-0"
        )}
      >
