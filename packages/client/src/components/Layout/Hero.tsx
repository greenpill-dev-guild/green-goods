                ...
                <div className="relative bg-white rounded-xl shadow-2xl p-6 w-full overflow-hidden">
                  ...
                  {deferredPrompt ? (
                    ...
                    <button
                      ...
                      className="w-full py-4 bg-[#367D42] hover:bg-[#2d6a36] text-white rounded-lg font-bold text-lg flex items-center justify-center gap-2 transition-colors shadow-md"
                    >
                      <RiDownloadLine className="w-6 h-6" />
                      <FormattedMessage
                        id="app.hero.install.native_button"
                        defaultMessage="Install App"
                      />
                    </button>
                  ) : (
