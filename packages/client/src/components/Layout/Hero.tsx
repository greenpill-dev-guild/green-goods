        ...
        {isMobile && !isInstalled && (
          <>
            {deferredPrompt ? (
              ...
              <Dialog.Root>
                <Dialog.Trigger className="px-6 py-4 bg-primary text-primary-foreground rounded-full w-full font-bold shadow-sm active:scale-95 transition-transform flex items-center justify-center gap-2">
                  <RiDownloadLine className="w-5 h-5" />
                  {intl.formatMessage({
                    id: "app.hero.install",
                    defaultMessage: "Install App",
                        ...
                        {platform === "ios" ? (
                          <>
                            <div className="flex items-start gap-3">
                              <div className="p-2 bg-information-lighter text-information-dark rounded-md shrink-0 border border-information-light">
                            ...
                            <div className="w-px h-4 bg-bg-sub-300 ml-5" />
                            <div className="flex items-start gap-3">
                              <div className="p-2 bg-bg-soft-200 text-text-sub-600 rounded-md shrink-0 border border-stroke-sub-300">
                          ...
                          <>
                            <div className="flex items-start gap-3">
                              <div className="p-2 bg-bg-soft-200 text-text-sub-600 rounded-md shrink-0">
