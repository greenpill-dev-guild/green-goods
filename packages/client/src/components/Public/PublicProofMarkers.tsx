 ...
 * `loading` paints a quiet dash, `unavailable` paints an em dash with a
 * screen-reader label (a failed source is never published as zero), and
 * `phrase` swaps the numeral for a short italic sentence when there is
 * genuinely nothing to count yet.
 */
...
export function PublicProofMarkers({ markers }: { markers: readonly PublicProofMarker[] }) {
