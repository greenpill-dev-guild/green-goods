...
export const pwaDrawerStyles = {
  overlay:
    "fixed inset-0 z-modal flex items-end justify-center bg-[var(--color-overlay)] backdrop-blur-[var(--blur-material-thick)]",
  dialogOverlay:
    "fixed inset-0 z-overlay bg-[var(--color-overlay)] backdrop-blur-[var(--blur-material-thick)]",
  overlayTransition:
    "transition-opacity duration-[var(--spring-effects-duration)] ease-[var(--spring-effects-easing)]",
  panel:
    "bg-[var(--color-material-thick)] backdrop-blur-[var(--blur-material-thick)] rounded-t-[var(--radius-lg)] shadow-[var(--shadow-float)] border border-stroke-soft-200 border-b-0 w-full overflow-hidden flex flex-col h-modal",
  dialogSurface:
    "bg-[var(--color-material-thick)] backdrop-blur-[var(--blur-material-thick)] rounded-[var(--radius-2xl)] shadow-[var(--shadow-float)] border border-stroke-soft-200",
  header:
    "flex items-center justify-between p-4 border-b border-stroke-soft-200 flex-shrink-0 bg-[var(--color-material-thick)] backdrop-blur-[var(--blur-material-thick)]",
  tabs: "flex border-b border-stroke-soft-200 flex-shrink-0 bg-[var(--color-material-regular)] backdrop-blur-[var(--blur-material-regular)]",
  tabTrigger:
  ...
  footer:
    "flex-shrink-0 border-t border-stroke-soft-200 bg-[var(--color-material-thick)] backdrop-blur-[var(--blur-material-thick)] p-4",
  closeButtonBase:
  ...
  workFeedbackDrawer:
    "absolute bottom-full left-0 right-0 bg-[var(--color-material-thick)] backdrop-blur-[var(--blur-material-thick)] rounded-t-[var(--radius-lg)] shadow-[var(--shadow-float)] border border-stroke-soft-200 border-b-0 overflow-hidden transition-transform duration-[var(--spring-spatial-duration)] ease-[var(--spring-spatial-easing)] origin-bottom",
  workActionBar:
    "bg-[var(--color-material-thick)] backdrop-blur-[var(--blur-material-thick)] border-t border-stroke-soft-200 rounded-t-[var(--radius-lg)] overflow-hidden shadow-[var(--shadow-float)]",
  workCloseButton:
