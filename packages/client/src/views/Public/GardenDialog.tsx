                ...
                <section aria-labelledby="public-garden-dialog-certs">
                  <SectionHeading
                    ...
                    helper={formatMessage({
                      ...
                      defaultMessage:
                        "Bundles of operator-approved Work, framed by evaluator assessments and anchored to a public blockchain.",
                    })}
                  />
      ...
      {notes.length === 0 ? (
        <p className="mt-4 text-sm italic text-text-soft-400">
          {formatMessage({
            ...
            defaultMessage: "No field notes yet — they appear as gardeners submit Work.",
          })}
        </p>
      ) : (
        <ul className="mt-4 flex flex-col divide-y divide-stroke-soft-200 border-y border-stroke-soft-200">
