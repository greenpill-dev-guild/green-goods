...
- Single-column numbered sections: **§ 01 Field notes → § 02 Commitments → § 03 Impact Certificates → § 04 Operators**. No side rail; only the transactional `/fund` carries one, and the dialect treats boxed rails as chrome.
