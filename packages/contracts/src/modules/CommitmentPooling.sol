...
///      Claims -> Confirmation -> Proof -> Views -> this contract. Only CommitmentPoolingStorage
///      declares state, so the frozen 38-entry + `__gap[12]` layout is independent of the split.
