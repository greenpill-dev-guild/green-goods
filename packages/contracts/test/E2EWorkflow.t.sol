...
contract E2EWorkflowTest is Test, ERC6551Helper {
    ...
    function testCompleteProtocolWorkflow() public {
        ...
        gardenAccountAddress = gardenToken.mintGarden(
            ...
            "E2E Test Garden",
            "A complete workflow test garden",
            "Test City",
            "ipfs://QmBanner",
            gardeners,
            operators
    ...
    function testMultiGardenParallelWorkflows() public {
        ...
        for (uint256 i = 0; i < 3; i++) {
            ...
            gardens[i] = gardenToken.mintGarden(
                address(communityToken),
                string(abi.encodePacked("Garden ", uint2str(i))),
                string(abi.encodePacked("Description ", uint2str(i))),
                "Location",
                "banner.jpg",
                gardeners,
                operators
    ...
    function testAssessmentWorkflow() public {
        ...
        gardenAccountAddress = gardenToken.mintGarden(
            address(communityToken),
            "Assessment Garden",
            "Garden for biodiversity assessment",
            "Test Location",
            "banner.jpg",
            gardeners,
            operators
