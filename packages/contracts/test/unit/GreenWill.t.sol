...
contract MaliciousGreenWillLock is IPublicLock {
    ...
    function getHasValidKey(address) external pure override returns (bool) { return false; }
    function keyExpirationTimestampFor(address) external pure override returns (uint256) { return 0; }
    ...
    function isLockManager(address) external pure override returns (bool) { return false; }
    function renounceLockManager() external override { }
    function name() external pure override returns (string memory) { return "MaliciousLock"; }
    function symbol() external pure override returns (string memory) { return "MLOCK"; }
    function maxNumberOfKeys() external pure override returns (uint256) { return type(uint256).max; }
    function expirationDuration() external pure override returns (uint256) { return 0; }
}
