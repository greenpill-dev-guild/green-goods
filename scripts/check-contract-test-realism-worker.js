#!/usr/bin/env node
/**
 * Contract Test Realism Audit — Worker
 *
 * Scans fork/E2E test files for mock primitives, generic expectRevert calls,
 ...
 *
 * Optional env:
 *   REALISM_TODAY              Override "today" date (YYYY-MM-DD)
 *   REALISM_REVERT_THRESHOLD   Override selector-specificity threshold
 *   CI                         Enables CI-specific checks
 */
