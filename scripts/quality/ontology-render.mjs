...
export function renderOntologyMdx(ontology, projections) {
  ...
  lines.push("");
  lines.push(
    "<!-- AUTO-GENERATED by scripts/quality/check-ontology.mjs --generate from packages/shared/src/ontology/green-goods-ontology.json. Do not edit; run `node scripts/quality/check-ontology.mjs --generate`. -->"
  );
  lines.push("");
...
export function renderMarketingClaimsMdx(projections) {
  const lines = [
    ...
    "---",
    "",
    "<!-- AUTO-GENERATED by node scripts/quality/check-ontology.mjs --generate. Do not edit directly. -->",
    "",
