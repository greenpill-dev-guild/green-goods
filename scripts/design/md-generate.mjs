 ...
 * Do not edit directly. Run \`node scripts/design/md-generate.mjs\`.
 *
...
if (CHECK_MODE && changed) {
  console.error("Run `node scripts/design/md-generate.mjs` and commit the updated generated artifacts.");
  process.exit(1);
}
