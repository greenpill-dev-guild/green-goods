...
The machine-readable ontology defines Community Member as a canonical persona. Historical product planning paired that persona with a public signal feed and Gardens conviction voting. The journey-codification review (2026-04-25) confirmed the conviction hooks already exist and are wired — but only into admin Community / Strategies / SignalPool views. There is **no public PWA view** in `packages/client/src/views/Public/` that lets a community member allocate signal. Community Member is the most under-served persona in the codebase right now.
...
- **Persona authority**: `packages/shared/src/ontology/green-goods-ontology.json`; the historical "Community Prioritization" JTBD is recorded here rather than retained as current implementation authority.
