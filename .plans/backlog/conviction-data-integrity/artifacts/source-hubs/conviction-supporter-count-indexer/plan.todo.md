# Conviction Supporter Count (Indexer) Plan

**Feature Slug**: `conviction-supporter-count-indexer`
**Stage**: `backlog`
**Status**: `ACTIVE`
**Created**: `2026-05-08T00:09:55.272Z`
**Last Updated**: `2026-05-08T00:09:55.272Z`
...
### UI (`claude/ui/conviction-supporter-count-indexer`)
...
### State / API (`codex/state-api/conviction-supporter-count-indexer`)
...
### Contracts (`codex/contracts/conviction-supporter-count-indexer`)
...
### QA Pass 1 (`claude/qa-pass-1/conviction-supporter-count-indexer`)

- [ ] Review UI behavior and user flow
- [ ] Verify acceptance criteria from `eval.md`
- [ ] Write `handoffs/claude-qa-pass-1.md`

### QA Pass 2 (`codex/qa-pass-2/conviction-supporter-count-indexer`)
