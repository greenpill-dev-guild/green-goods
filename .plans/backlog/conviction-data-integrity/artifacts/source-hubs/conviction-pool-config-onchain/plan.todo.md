# Conviction Pool Config Onchain Plan

**Feature Slug**: `conviction-pool-config-onchain`
**Stage**: `backlog`
**Status**: `ACTIVE`
**Created**: `2026-05-08T00:09:47.512Z`
**Last Updated**: `2026-05-08T00:09:47.512Z`
...
### UI (`claude/ui/conviction-pool-config-onchain`)
...
### State / API (`codex/state-api/conviction-pool-config-onchain`)
...
### Contracts (`codex/contracts/conviction-pool-config-onchain`)
...
### QA Pass 1 (`claude/qa-pass-1/conviction-pool-config-onchain`)

- [ ] Review UI behavior and user flow
- [ ] Verify acceptance criteria from `eval.md`
- [ ] Write `handoffs/claude-qa-pass-1.md`

### QA Pass 2 (`codex/qa-pass-2/conviction-pool-config-onchain`)
