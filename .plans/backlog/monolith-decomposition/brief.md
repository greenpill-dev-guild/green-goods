...
> No decomposition code was written when this hub was created — capture/tracking only. This is backlog tracking until a slice is activated through the `develop -> PR -> main` flow.
...
## Notes
- This hub is backlog execution truth; Linear PRD-563 / PRD-574 / PRD-566 / PRD-565 mirror it for visibility (`source:plans`).
- Implementation lanes should remain parent-only in Linear until a decomposition slice is explicitly activated.
