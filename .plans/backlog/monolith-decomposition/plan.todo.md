...
Completed in July 2026: **1.2 -> 1.1 -> 1.3**. Each slice was structure-only and preserved its existing caller or route contract. The hub remains in backlog as historical execution truth; this reconciliation does not create Linear activity.
...
- [x] ADR-020 acceptance authorized the structure-only extraction; no campaign-to-Seasons rename was included.
