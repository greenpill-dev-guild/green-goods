...
1. Run `node scripts/harness/plan-hub.mjs list --agent codex --lane qa_pass_2 --json`
2. If no ready feature exists, stop
3. Pick the first ready feature
4. Confirm the branch trigger exists:
   - `node scripts/harness/plan-hub.mjs check-branch --feature <feature-slug> --lane qa_pass_2`
...
7. Mark the lane in progress:
   - `node scripts/harness/plan-hub.mjs set-lane --feature <feature-slug> --lane qa_pass_2 --status in_progress --actor codex --branch codex/qa-pass-2/<feature-slug>`
