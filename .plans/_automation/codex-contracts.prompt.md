...
1. Run `node scripts/harness/plan-hub.mjs list --agent codex --lane contracts --json`
...
6. Mark the lane in progress:
   - `node scripts/harness/plan-hub.mjs set-lane --feature <feature-slug> --lane contracts --status in_progress --actor codex --branch codex/contracts/<feature-slug>`
