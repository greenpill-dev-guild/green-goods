...
1. Run `node scripts/plan-hub.mjs list --agent claude --lane qa_pass_1 --json`
...
6. Mark the lane in progress:
   - `node scripts/plan-hub.mjs set-lane --feature <feature-slug> --lane qa_pass_1 --status in_progress --actor claude --branch claude/qa-pass-1/<feature-slug>`
