...
| AC-16 | Linear/check-in proof | Linear comments and status JSON record phase gates after phases 2, 3, 5, and 6. | `system` | Status history records the Phase 3 correction, Phase 4/5 check-in, and the 2026-06-02 local review-fix correction. Existing Linear comments were refreshed for the pre-fix Phase 4/5 proof; they have not yet been refreshed after the local send-payment/Card Endow correction. |
