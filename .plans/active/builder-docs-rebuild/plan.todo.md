...
| D7 real category landings | 1 (CSS fallback) + 3 (pages) | ⏳ |
| D8 Skills catalog + Working with Agents | 1 (generator) + 4 (prose/READMEs) | ⏳ |
...
| ERD layered + zoomable | 1 | ⏳ |
| Spine rewrites (Getting Started, First Contribution, System Overview) | 2 | ⏳ |
