...
- The fourth pilot garden remains anonymous in presentation-facing and operational artifacts until first contact confirms participation. Refer to it only as “a fourth garden — in outreach, named only once participation is confirmed”; retain the mature MRV-adoption selection criteria without exposing the outreach target.
