...
1. `visual-assets-artifact.build.ts` writes the two build targets — four audience tabs: story; **23 named Architecture sections D1–D16** (including D1b, D7b, D7c, D7d, D10b, D11b, D13b) rendered as **34 Architecture Mermaid blocks** behind a hand-written opener; the canonical CP screen states, each frame badged *pending sync with UI prototypes*; and Reference.
