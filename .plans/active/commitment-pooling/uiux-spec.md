...
| Paused | Banner “new participation paused by stewards” with indexed reason; browse, evidence/linkage, cancellation/expiry, and dispute recovery remain available; the app hides create/claim/Ready-submit/confirm controls for the quiet period as a product choice — on-chain, only creation-side writes are gated (decision 2026-08-11) | Pause reason + resume action; safe-wind-down controls remain | Neutral quiet-period line, aggregates stay | View-only plus allowed recovery |
