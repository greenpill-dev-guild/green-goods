...
- W2 shows team membership, each contributor's linked Work/evidence credit, optional requirement
  ...
  field queue. Leave is available only to an active non-lead Open-team contributor with zero
  Work/evidence credit; lead or credited removal is blocked with attribution-preserving copy.
