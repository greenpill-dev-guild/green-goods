...
5. Shared substrate (types, hooks, five field queue kinds plus one automatic settlement queue kind and online wallet `transfer`, settlement selectors) consumed by admin + client + editorial surfaces.
