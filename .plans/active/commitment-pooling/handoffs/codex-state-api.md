...
- Validated paths: `packages/shared/src/modules/commitment-pooling/**`, its hooks, tests, stories,
  exports and test utilities; `packages/agent/src/api/routes/saved-offers.ts`, Saved Offer services,
  database adapters, tests, and package validation configuration.
