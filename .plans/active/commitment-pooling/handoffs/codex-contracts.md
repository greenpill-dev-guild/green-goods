...
- Exact command(s): all twelve commands in `## Exact Bun commands` above, beginning with `bun run
  --filter @green-goods/contracts test:match -- test/unit/CommitmentPooling.t.sol`.
