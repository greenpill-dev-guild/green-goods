...
**Last aligned with canonical synthesis**: v5 (2026-07-05) — [Commitment Pooling × Green Goods — Grassroots Economics Learnings, and the Full Flywheel We're Building](https://linear.app/greenpill-dev-guild/document/commitment-pooling-green-goods-grassroots-economics-learnings-and-the-d3939e890b14). **Corrections applied since v5**: the fund topology (House of Alignment streams directly to the Green Goods protocol Safe on Celo — the earlier working-capital hop is retired) and per-action required-work counts, both from the 2026-07-18 audit response (`reports/corrections-log.md` §9–10).
