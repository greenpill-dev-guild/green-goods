...
**Planned**: the commitment pooling module and its register (August 31); G$ settlement (August 31 — every focus garden is settlement-capable, with Tech and Sun Hub planned as the first execution); the community app for needs and confirmations (September 30). The pilot focuses on four named gardens — Tech and Sun Hub (Awka, Nigeria), Greenpill Cape Town (South Africa), AgroforestDAO / Redemption Hill (Bias Fortes, Brazil), and Barichara Regenerativa (Barichara, Santander, Colombia) — which together exercise all four action domains: solar, education, waste, and agroforestry. Barichara Regenerativa, selected 2026-07-11, anchors the pilot's mature-organization slot: an established agroforestry community adopting Green Goods to make impact it already delivers legible to funders. Naming a garden never presumes its readiness. Each confirms participation through research sessions and a corrected mandate first.
