...
| --- | --- | ---: | --- |
| W1 | Client PWA | 33 | open, create-open, not-ready, ready, seeded, empty-open, no-season, funded-offer, request-open, request-work-open, request-queued, request-work-queued, exchange-queued, queued, support-queued, ongoing-queued, sync-failed, reviewing, paused, closed, composted, cancelled-cycle, paused-cancelled-cycle, campaign-market, campaign-tools, waiting-membership, claim-pending, claim-declined, claim-superseded, claim-accepted, loading, not-found, read-error |
| W1C | Client PWA | 10 | season, season-ended, campaign, people, people-ended, insights, insights-ended, all-seasons, loading, read-error |
| W2 | Client PWA | 85 | accepted, accepted-joinable, offered, active, active-waiting, contributor, evidence-queued, evidence-submitted, evidence-preview, partially-approved, ready-provider, ready-confirmer, confirmation-pending, fulfilled, fulfilled-confirmer, fulfilled-pool-fallback, fulfilled-protocol-fallback, reward-released, withdraw-confirm, withdrawn, requested, request-withdraw-confirm, request-withdrawn, request-active, request-evidence-queued, request-evidence-submitted, request-ready-pending, request-ready-confirmer, request-confirmation-pending, request-fulfilled, browse-offered, browse-requested, browse-requested-gated, send-confirm, support-offered, support-accepted, support-accepted-confirmer, support-evidence-queued, support-evidence-submitted, support-ready-pending, support-ready-confirmer, support-confirmation-pending, support-fulfilled, support-cancelled, support-disputed, support-queued, support-en-route, support-delayed, support-executed, support-confirming, support-arrived, support-failed, support-cancelled-queued, support-cancelled-failed, reconciled, cancelled, expired, disputed, campaign-request-disputed, request-disputed, captured, captured-evidence-queued, captured-evidence-submitted, captured-ready-pending, captured-ready-confirmer, captured-confirmation-pending, captured-fulfilled, captured-disputed, garden-provider, garden-support-arrived, campaign-request-active, campaign-request-evidence-queued, campaign-request-evidence-submitted, campaign-request-ready-pending, campaign-request-ready-confirmer, campaign-request-confirmation-pending, campaign-request-fulfilled, request-work-active, request-work-partially-approved, request-work-ready-confirmer, request-work-confirmation-pending, request-work-fulfilled, loading, not-found, read-error |
| W2a | Client PWA | 10 | media, media-preview, details, review, review-request, review-campaign-request, review-support, review-captured, queued, failed |
| W2b | Client PWA | 13 | setup, forming, forming-service, add-sheet, add-sheet-search, add-sheet-no-match, remove-contributor, assign-requirement, open-eligible, join-submitted, open-member, frozen, recognition |
| W3 | Client PWA | 34 | step-what, repeat-noticed, step-howmuch, step-details, details-preview, step-review, step-review-read, support-howmuch, support-details, support-howmuch-ongoing, support-details-ongoing, support-review, support-review-ongoing, step-advanced, advanced-work-ask, step-advanced-no-protocol, step-confirmers, step-confirmers-work, request-what, request-howmuch, request-details, request-howmuch-steward, request-details-steward, request-review, request-review-steward, request-work-what, request-work-howmuch, request-work-details, request-work-review, saved-offer-edit, saved-offer-review, saved-offer-queued, draft-resume, validation |
...
| W36 | Client PWA | 10 | waiting-pledge, deposit-instructions, deposit-sent, pending-acceptance, funded, refund-queued, refunded, loading, not-found, read-error |
| W5 | Client PWA | 19 | default, queued, waiting-membership, send-failed, empty, loading, not-found, read-error, overtime, overtime-empty, overtime-ready, overtime-queued, overtime-queued-waiting, overtime-loading, overtime-read-error, toconfirm, toconfirm-empty, toconfirm-loading, toconfirm-read-error |
...
| W32 | Client PWA | 8 | compose, choose-path, draft-unsaved, saving, save-failed, offline-local, version-conflict, persistence |
| W34 | Client PWA | 24 | active-two, active-none, active-one, places-queued, places-partial, places-partial-failed, story, participation, ask-again, claimant-view, pool-ready, pool-paused, pool-closed, pool-composted, edit-active, edit-active-none, edit-active-ready, edit-stopped, stopped, stopped-none, stop-confirm, preview, loading, read-error |
...
| W7 | Admin console | 32 | open, claims, claim-declined, claim-outcomes, expiry-queue, due-live, series-view, read-error, empty, open-no-cycle, seeded, not-ready, preflight-complete, ready, paused, paused-cycle-composted, paused-cycle-cancelled, reconciled, cycle-composted, close-blocked-live, pool-closed, pool-composted, compost-pool-confirm, reopen-confirm, pause-confirm, close-pool-confirm, paused-close-pool-confirm, cancel-cycle-confirm, paused-cancel-cycle-confirm, decline-claim-confirm, edit-pool, loading |
| W7C | Admin console | 8 | season, season-finished, campaign, people, insights, insights-finished, loading, read-error |
| W7M | Admin console | 3 | pool, fab-open, seed-sheet |
| W8 | Admin console | 7 | step1, step2, step3, step3-no-protocol, step4, captured-for, discard |
