...
- 35 presentation-visible hi-fi screens / 455 states: 18 Client PWA (292 states), 15 Admin console (158 states), 2 Editorial website (5 states)
- 668 registered hotspots
...
- 90 component entries / 156 static specimens on the Components tab (46 Client PWA · 38 Steward console · 4 Editorial), every entry anchored at `#components/<id>[@surface]` with shipping citation or net-new note; shipped-palette parity: shipping names lead admin entry titles
