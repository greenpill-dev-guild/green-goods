...
{ id: "sb10", n: 10, title: "Declare a reward and record its payout", persona: "Steward (David) + gardener", scen: "S13 · July's only rail", reviewVisible: true, reviewGroup: "admin", steps: [
  ...
  { f: "W10@external-fulfilled", hot: null, st: "Fulfilled", ev: "confirmFulfillment (ordinary named path — every frozen team member excluded)", cite: "CS §6.1" },
...
{ id: "sb12", n: 12, title: "Dispatch queued support and close the loop", persona: "Steward + protocol executor", scen: "S8/S9 · pre-broadcast proof", reviewVisible: true, reviewGroup: "admin", steps: [
  { f: "W21@payout-finalized", hot: { h: "w21.prepare-payout", l: "Prepare payout" }, st: "Finalized · unprepared", ev: "the steward materializes exactly one immutable queued child from the frozen contributor row; an exact repeat returns the same settlement ID", cite: "SS §3" },
  { f: "W21@payout-prepared", hot: { h: "w21.create-batch", l: "Create batch" }, st: "Queued deliveries", ev: "the prepared child can enter the optional homogeneous batch review before membership becomes immutable", cite: "SS §3" },
