...
{ id: "sb5", n: 5, title: "“Not yet” → steward review → resolutions", persona: "Recipient + Steward", scen: "S5", surface: "PWA + Admin", reviewVisible: true, reviewGroup: "end-to-end", steps: [
  ...
  { f: "W2", hot: null, ev: "every reason renders in the member timeline too", cite: "UX:300", note: "register #34b adopted member pre-acceptance withdraw (MF-2a); register #51 locks steward cancel in W10 (MF-2b)" },
]},
...
{ id: "sb10", n: 10, title: "Declared reward → payout", persona: "Steward + Gardener", scen: "S13 · July's only rail", surface: "Admin + PWA", reviewVisible: true, reviewGroup: "admin", steps: [
  { f: "W8@step3", hot: null, marks: ["w8.reward"], who: "David", surface: "admin", ev: "ArbitrumExternal is selected; the declared reward is a reference only and the module never custodies funds", cite: "WF:339 · UX:280" },
  ...
  { f: "W10", hot: { h: "w10.record-payout", l: "Record payout" }, surface: "admin", ev: "ArbitrumExternal permits AdminConfirmDialog to capture the rail reference → recordRewardPaid → RewardPaid", cite: "CS:749", note: "register #34h — the dry run runs this with a real minimal Cookie Jar withdrawal" },
...
{ id: "sb12", n: 12, title: "CCIP command/ack path", persona: "Steward + protocol executor", scen: "S8/S9 · pre-broadcast proof", surface: "Admin + automated Celo route", reviewVisible: true, reviewGroup: "admin", steps: [
  ...
  { f: "W22", hot: { h: "w22.cancel-batch", l: "Cancel whole queued batch" }, surface: "admin", st: "Queued branch", ev: "reasoned cancelBatch atomically closes the immutable member set; no partial member path", cite: "SS §3.2", br: [{ l: "Keep queued and dispatch", to: "sb12:3" }] },
  { f: "W22", hot: { h: "w22.dispatch-command", l: "Dispatch command" }, surface: "admin", ev: "dispatch sends versioned data only with zero token amounts", cite: "SS §3" },
