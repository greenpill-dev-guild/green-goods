...
{ id: "sb3", n: 3, title: "Steward-reviewed claim", persona: "Ana + João + Steward (David)", scen: "S3 · scarce crew slots", surface: "PWA + Admin", reviewVisible: true, reviewGroup: "end-to-end", steps: [
  ...
  { f: "W7@claims", hot: { h: "w7.decline-claim", l: "Decline Ana's row (reason)" }, alts: [{ h: "w7.accept-claim", l: "or accept João now", to: "sb3:9" }], who: "David", surface: "admin", ev: "declineClaim + reason → ClaimDeclined — only Ana's row changes; João stays Pending", cite: "CS:734 · UX:105" },
  { f: "W7@decline-claim-confirm", hot: { h: "w7.decline-claim-confirm", l: "Decline request" }, who: "David", surface: "admin", ev: "the confirmation takes the required reason and names what it does not touch — João's request stays pending", cite: "CS:734" },
  { f: "W7@claim-declined", hot: null, who: "David", surface: "admin", st: "Ana declined", ev: "the console shows Ana declined while João remains pending", cite: "CS:734" },
  ...
  { f: "W7@claims", hot: { h: "w7.accept-claim", l: "Accept João's row" }, who: "David", surface: "admin", ev: "acceptClaim consumes João's stored terms → CommitmentAccepted · every other pending row → Superseded", cite: "CS:733 · DG:696" },
...
{ id: "sb4", n: 4, title: "Evidence, work linkage, assessment", persona: "Gardener + Evaluator (Dr. Chen) + Steward", scen: "S4 · AGRO+EDU", surface: "PWA + Admin", reviewVisible: true, reviewGroup: "end-to-end", steps: [
  ...
  { f: "HUBWORK", hot: null, who: "steward", surface: "admin", st: "Approved work counted · 2 of 2", ev: "the second approval reaches requiredApprovedWorkCount on the same surface — the assessment is still separately declared", cite: "CS:737 · CS:138a" },
...
{ id: "sb6", n: 6, title: "Expiry → offer again", persona: "Owner + Steward + anyone", scen: "S1/S5 edge", surface: "PWA + Admin", reviewVisible: true, reviewGroup: "end-to-end", steps: [
  ...
  { f: "W8@step3", hot: { h: "w8.continue-rule", l: "Continue" }, who: "David", surface: "admin", ev: "checks confirmers, threshold, and claim mode", cite: "UX:94" },
  { f: "W8@step4", hot: { h: "w8.continue-reward", l: "Continue" }, who: "David", surface: "admin", ev: "checks the declared reward rail and its reference", cite: "UX:94" },
  { f: "W8@step5", hot: { h: "w8.seed", l: "Seed this commitment" }, who: "David", surface: "admin", ev: "creates a fresh seeded commitment", cite: "UX:94" },
...
{ id: "sb8", n: 8, title: "Analog capture + fallback", persona: "Steward (David) + member", scen: "S7 · device-free member", surface: "Admin + PWA", reviewVisible: true, reviewGroup: "admin", steps: [
  ...
  { f: "W8@captured-for", hot: { h: "w8.record", l: "Record it" }, surface: "admin", ev: "commitment job (OperatorCaptured, onBehalfOf) → CommitmentCreated(creator = member, recordedBy = steward)", cite: "CS:730 · DG:236" },
...
{ id: "sb9a", n: 9, title: "Pool readiness → season open", persona: "Steward", scen: "S5/S13 admin side", surface: "Admin (+ member echo)", reviewVisible: true, reviewGroup: "admin", steps: [
  ...
  { f: "W7@ready", hot: { h: "w7.seed-fab", l: "Seed the Season" }, alts: [{ h: "w7.open-pool", l: "or open the pool first — the card action (register #34a)", to: "screen:W7" }], st: "Ready", ev: "seedCycle is legal while the pool is Ready (CS:726); the flow's open step then carries the Ready-pool guard, which opens the pool with the cycle — the same deadlock fix register #34a adopted onto the card", cite: "CS:726 · CS:100", mf: true },
  ...
  { f: "W8@step3", hot: { h: "w8.continue-rule", l: "Continue" }, who: "David", surface: "admin", ev: "sets confirmers, threshold, and claim mode", cite: "CS:726" },
  { f: "W8@step4", hot: { h: "w8.continue-reward", l: "Continue" }, who: "David", surface: "admin", ev: "sets the declared reward rail and its reference", cite: "CS:726" },
  { f: "W8@step5", hot: { h: "w8.seed", l: "Seed this commitment" }, who: "David", surface: "admin", ev: "seedCycle records the new Season campaign", cite: "CS:726" },
...
{ id: "sb9b", n: 9, title: "Pause and resume the pool", persona: "Steward", scen: "S5/S13 admin side", surface: "Admin (+ member echo)", reviewVisible: true, reviewGroup: "admin", steps: [
...
{ id: "sb9c", n: 9, title: "End a season — close, compost, or cancel", persona: "Steward", scen: "S5/S13 admin side", surface: "Admin (+ member echo)", reviewVisible: true, reviewGroup: "admin", steps: [
  ...
  { f: "W7@cycle-composted", hot: { h: "w7.close-pool", l: "Close pool" }, who: "David", surface: "admin", st: "All cycles composted", ev: "every cycle — the Season and all three Campaigns — has composted, which is the condition that makes Close pool appear at all (uiux §6.2); seeding the next cycle stays available beside it", cite: "CS:102" },
  { f: "W7@close-pool-confirm", hot: { h: "w7.close-pool-confirm", l: "Close pool" }, who: "David", surface: "admin", st: "Close — confirm", ev: "closing ends participation for the pool's 23 members; the confirmation names that blast radius — closePool stores no reason (CS:556)", cite: "CS:102 · CS:556" },
  { f: "W7@pool-closed", hot: null, who: "David", surface: "admin", st: "Closed", ev: "the steward console records the closed pool; compost archives it and reopen starts the next era", cite: "CS:102" },
...
{ id: "sb10", n: 10, title: "Declared reward → payout", persona: "Steward + Gardener", scen: "S13 · July's only rail", surface: "Admin + PWA", reviewVisible: true, reviewGroup: "admin", steps: [
  { f: "W8@step4", hot: null, marks: ["w8.reward"], who: "David", surface: "admin", ev: "the external payout record is selected; the declared reward is a reference only and the module never custodies funds", cite: "WF:339 · UX:280" },
  { f: "W2", hot: null, surface: "pwa", marks: ["w2.reward-row"], ev: "member external-reward row: '20 DAI from the garden jar · pending'", cite: "WF:159" },
  ...
  { f: "W10", hot: null, surface: "admin", st: "ReadyForConfirmation", ev: "the promise opens still awaiting its named confirmations — the reward is declared but not yet recordable", cite: "UX:318" },
  { f: "W10@fulfilled", hot: null, surface: "admin", st: "Fulfilled", ev: "confirmFulfillment (ordinary named path — provider excluded)", cite: "CS:743" },
  { f: "W10@fulfilled", hot: { h: "w10.record-payout", l: "Record payout" }, surface: "admin", ev: "ArbitrumExternal permits AdminConfirmDialog to capture the rail reference → recordRewardPaid → RewardPaid", cite: "CS:749", note: "register #34h — the dry run runs this with a real minimal Cookie Jar withdrawal" },
...
{ id: "sb12", n: 12, title: "CCIP command/ack path", persona: "Steward + protocol executor", scen: "S8/S9 · pre-broadcast proof", surface: "Admin + automated Celo route", reviewVisible: true, reviewGroup: "admin", steps: [
...
{ id: "sb13", n: 13, title: "Cross-garden protocol claim", persona: "Garden Steward (Leila)", scen: "S14", surface: "PWA + Admin", reviewVisible: true, reviewGroup: "end-to-end", steps: [
  ...
  { f: "W10", hot: null, st: "ReadyForConfirmation", ev: "the garden-provided promise opens awaiting its named confirmations", cite: "UX:318" },
  { f: "W10@fulfilled", hot: null, st: "Fulfilled", ev: "named confirmer (or reasoned fallback) confirms · co-funded reward references stay with the owning garden · never custody or member-delivery via garden claims", cite: "UX:313 · AM:38-39" },
]},
