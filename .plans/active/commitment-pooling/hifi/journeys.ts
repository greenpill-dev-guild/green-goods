...
{ id: "sb1", n: 1, title: "Offer support and see it taken up", persona: "Gardener (Maria)", scen: "S1 · TAS workshop", reviewVisible: true, reviewGroup: "client", chapter: "make", roles: ["gardener"], steps: [
  { f: "W1", hot: { h: "w1.offer" }, who: "Maria", st: "Pool Open · cycle Open", ev: "routes to /home/:id/pool/new?direction=offer", cite: "WF:76 · UX:122" },
...
{ id: "sb51", n: 51, title: "Ask for garden work and see it approved", persona: "Gardener (Ana) + helper (João)", scen: "S2 · DomainImpact request", reviewVisible: true, reviewGroup: "client", chapter: "ask", roles: ["gardener"], steps: [
  { f: "W1", hot: { h: "w1.request" }, who: "Ana", ev: "routes to /pool/new?direction=request", cite: "WF:76" },
  { f: "W3@request-what", hot: { h: "w3.request-continue-what", l: "Continue" }, who: "Ana", marks: ["w3.request-choose-work"], st: "Draft (local)", ev: "Ana picks Garden work — the ask will carry action requirements and ride the Work-approval rails", cite: "CS:385,387 · UX:618" },
  { f: "W3@request-howmuch", hot: { h: "w3.request-continue-work", l: "Continue — garden work path" }, who: "Ana", st: "Draft (local)", ev: "unit and amount stay chip picks; the garden-work path adds one proof step", cite: "UX:618" },
...
{ id: "sb3a", n: 3, title: "Ask to take up a promise and hear back", persona: "Gardeners (Maria + João)", scen: "S3 · scarce crew slots", reviewVisible: true, reviewGroup: "client", chapter: "take-up", roles: ["gardener"], steps: [
  ...
  { f: "W1@claim-accepted", hot: { h: "w1.open-commitment", l: "Open the promise" }, who: "João", st: "Accepted", ev: "the steward accepts João — acceptance consumes his stored terms and supersedes every other pending row; the accepted claimant opens the same ride request", cite: "CS:733 · DG:696 · UX:104" },
  { f: "W2@request-active", hot: null, who: "João", st: "Accepted", ev: "the accepted ride request continues on its evidence-only path", br: [{ l: "Continue with request evidence", to: "sb43:1" }] },
...
{ id: "sb44", n: 44, title: "A promise recorded for you", persona: "Member (Kwame) + confirmer (Ana)", scen: "S7 · device-free member", reviewVisible: true, reviewGroup: "client", chapter: "confirm", roles: ["member", "gardener"], steps: [
  ...
  { f: "W2@captured-ready-confirmer", hot: { h: "w2.confirm-captured-detail", l: "Review confirmation" }, who: "Ana", st: "ReadyForConfirmation", ev: "the named counterparty may confirm; every contributor remains blocked", cite: "CS §6.1", br: [{ l: "Eligible local steward → garden fallback with reason", to: "screen:W10@fallback-confirm" }, { l: "No eligible local confirmer → Green Goods team fallback (pilot default)", to: "screen:W10@protocol-fallback-confirm" }] },
  { f: "W4@confirm-captured", hot: { h: "w4.confirm-captured", l: "Confirm — promise kept" }, alts: [{ h: "w4.not-yet-captured", l: "Not yet → steward review", to: "screen:W4@not-yet-captured" }], who: "Ana", st: "ReadyForConfirmation", ev: "the counterparty confirms the same recorded promise without changing its member source", cite: "CS:139", br: [{ l: "Not-yet send fails → keep recorded promise and reason for retry", to: "screen:W4@not-yet-failed-captured" }] },
  { f: "W4@confirmed-pending-captured", hot: null, who: "Ana", st: "Pending local sync", ev: "the optimistic meter counts the saved confirmation while fulfillment waits for sync", cite: "UX:169,221" },
  { f: "W4@confirmed-captured", hot: { h: "w4.done-captured", l: "Back to the pool" }, who: "Ana", st: "Fulfilled", ev: "sync completion shows the quiet result for the same StewardCaptured promise", cite: "UX:197-204" },
  { f: "W2@captured-fulfilled", hot: null, who: "Kwame", st: "Fulfilled · steward record", ev: "the member sees the fulfilled recorded promise with its source marker intact", cite: "UX:301" },
]},
...
{ id: "sb35", n: 35, title: "Create and accept a bilateral exchange pair", persona: "Maria (offers B) + Ana (accepts)", scen: "S16 · bilateral exchange", reviewVisible: true, reviewGroup: "client", chapter: "make", roles: ["gardener"], steps: [
  ...
  { f: "W28@selected", hot: { h: "w28.submit", l: "Make this offer in exchange" }, who: "Maria", st: "You give · you receive", ev: "the executor re-reads Ana's Offer for early feedback; createCommitment repeats every predicate atomically before storing counterCommitmentId · CommitmentCreated(B, counterCommitmentId=A)", cite: "CS §5.3 · WF:1219", br: [{ l: "A changed before mining → no B created, clear or replace", to: "screen:W28@selection-invalid" }] },
