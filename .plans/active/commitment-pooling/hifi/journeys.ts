...
{ id: "sb9c", n: 9, title: "End a season — close, compost, or cancel", persona: "Steward", scen: "S5/S13 admin side", surface: "Admin (+ member echo)", reviewVisible: true, reviewGroup: "admin", steps: [
  ...
  { f: "W7@cycle-composted", hot: { h: "w7.close-pool", l: "Close pool" }, who: "David", surface: "admin", st: "Season composted", ev: "the composted season's history is visible, and the pool card now offers Close — the act appears only after the last cycle composts (uiux §6.2)", cite: "CS:102" },
