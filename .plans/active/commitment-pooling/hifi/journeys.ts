...
{ id: "sb9c", n: 9, title: "End a season — close, compost, or cancel", persona: "Steward (David)", scen: "S5/S13 admin side", reviewVisible: true, reviewGroup: "admin", steps: [
  { f: "W7@manage", hot: { h: "w7.close-season", l: "Close Season (reconcile)" }, st: "Reconciled", ev: "closeCycle → CycleClosed — commitments derive Reconciled", cite: "CS:118,140", br: [{ l: "Variant: cancel the season instead", to: "sb9c:13" }] },
  ...
  { f: "W26@rest", hot: { h: "w26.compost", l: "Compost cycle" }, st: "Composted", ev: "closeCycle already reconciled the cycle; this final act calls compostCycle only", cite: "UX:75", mf: true },
  ...
  { f: "W7@pool-closed", hot: { h: "w7.compost-pool", l: "Compost pool" }, who: "David", st: "Closed", ev: "compostPool archives the closed pool while preserving its history", cite: "CS:103" },
...
{ id: "sb27", n: 27, title: "Open a campaign while no Season is running", persona: "Gardener", scen: "S1 · campaign-only window", reviewVisible: true, reviewGroup: "client", steps: [
  ...
  { f: "W1@campaign-market", hot: { h: "w1.take-up-request", l: "I can help" }, st: "Campaign Open", ev: "the campaign exposes its own legal request action and keeps its scope visible", cite: "UX:127 · CS:133" },
  { f: "W2@request-active", hot: null, st: "Accepted", ev: "the campaign request continues on the ordinary evidence-only promise path", cite: "UX:153" },
]},
...
{ id: "sb29", n: 29, title: "Offer a service and confirm it from evidence", persona: "Gardener (Maria) + recipient (João)", scen: "S1 · SupportService offer", reviewVisible: true, reviewGroup: "client", steps: [
  ...
  { f: "W4@confirm-support", hot: { h: "w4.confirm-support", l: "Confirm — promise kept" }, alts: [{ h: "w4.not-yet-support", l: "Not yet → steward review", to: "screen:W4@not-yet-support" }], who: "João", st: "ReadyForConfirmation", ev: "the recipient confirms; Maria remains excluded as provider", cite: "CS:139" },
...
{ id: "sb32", n: 32, title: "Wind down a season while its pool stays paused", persona: "Steward (David)", scen: "S5 · paused wind-down", reviewVisible: true, reviewGroup: "admin", steps: [
  { f: "W7@paused", hot: { h: "w7.close-season-paused", l: "Close season" }, alts: [{ h: "w7.cancel-cycle-paused", l: "or cancel with a reason", to: "sb32:6" }], st: "Pool Paused · cycle Open", ev: "closeCycle reconciles the cycle without resuming participation", cite: "CS:111,128" },
  { f: "W26@paused-review", hot: { h: "w26.paused-continue-shares", l: "Continue to shares" }, st: "Pool Paused · cycle Reconciled", ev: "the closeout sequence keeps the pool state visible while unresolved promises are reviewed", cite: "UX:60,75" },
  { f: "W26@paused-shares", hot: { h: "w26.paused-continue-certificate", l: "Continue to certificate" }, st: "Pool Paused · cycle Reconciled", ev: "the locked six-role allocation is read without changing either lifecycle", cite: "UX:75" },
  { f: "W26@paused-certificate", hot: { h: "w26.paused-mint", l: "Mint impact certificate" }, st: "Pool Paused · cycle Reconciled", ev: "certificate minting bundles impact records but changes no pool or cycle state", cite: "CS §9" },
  { f: "W26@paused-rest", hot: { h: "w26.paused-compost", l: "Compost cycle" }, st: "Pool Paused · cycle Reconciled", ev: "compostCycle advances only the cycle to Composted", cite: "CS:129" },
