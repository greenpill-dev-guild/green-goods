...
{ id: "sb19", n: 19, title: "Pay a garden team from its Safe", persona: "Garden steward", scen: "S14 · settlement", reviewVisible: true, reviewGroup: "admin", steps: [
  ...
  { f: "W21@payout-plan", hot: { h: "w21.edit-plan", l: "Edit payout draft" }, st: "Draft · editable", ev: "the steward may replace the complete amount vector, retention, and reason before finalization without creating a second parent plan", cite: "SS §3.1" },
...
{ id: "sb33", n: 33, title: "Recognize and pay a commitment team", persona: "Lead gardener + contributors + steward", scen: "S1 · group commitment", reviewVisible: true, reviewGroup: "admin", steps: [
  ...
  { f: "W21@payout-plan", hot: { h: "w21.edit-plan", l: "Edit payout draft" }, st: "Draft parent plan · editable", ev: "the steward can correct the complete vector, retention, and reason before choosing to finalize", cite: "SS §3" },
