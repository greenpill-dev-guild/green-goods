...
{ id: "sb3", n: 3, title: "Steward-reviewed claim", persona: "Ana + João + Steward (David)", scen: "S3 · scarce crew slots", surface: "PWA + Admin", reviewVisible: true, reviewGroup: "end-to-end", steps: [
  ...
  { f: "W7@claims", hot: { h: "w7.decline-claim", l: "Decline Ana's row (reason)" }, alts: [{ h: "w7.accept-claim", l: "or accept João now", to: "sb3:8" }], who: "David", surface: "admin", ev: "declineClaim + reason → ClaimDeclined — only Ana's row changes; João stays Pending", cite: "CS:734 · UX:105" },
...
{ id: "sb9b", n: 9, title: "Pause and resume a season", persona: "Steward", scen: "S5/S13 admin side", surface: "Admin (+ member echo)", reviewVisible: true, reviewGroup: "admin", steps: [
...
{ id: "sb9c", n: 9, title: "End a season — close, compost, or cancel", persona: "Steward", scen: "S5/S13 admin side", surface: "Admin (+ member echo)", reviewVisible: true, reviewGroup: "admin", steps: [
  ...
  { f: "W7@close-pool-confirm", hot: { h: "w7.close-pool-confirm", l: "Close pool" }, who: "David", surface: "admin", st: "Close — confirm", ev: "closing ends participation for the pool's 23 members; the confirmation says so, and takes a reason, before it happens", cite: "CS:102" },
