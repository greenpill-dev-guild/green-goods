...
{ id: "sb9a", n: 9, title: "Ready the pool and open the season", persona: "Steward (David)", scen: "S5/S13 admin side", reviewVisible: true, reviewGroup: "admin", steps: [
  ...
  { f: "W8@step1", hot: { h: "w8.continue-scope", l: "Continue" }, who: "David", ev: "sets the cycle-scoped promise type and direction", cite: "CS:726" },
  { f: "W8@step2", hot: { h: "w8.continue-requirements", l: "Continue" }, who: "David", ev: "sets units, targets, requirements, and due rule", cite: "CS:726" },
  { f: "W8@step3", hot: { h: "w8.continue-rule", l: "Continue" }, who: "David", ev: "sets confirmers, threshold, and claim mode", cite: "CS:726" },
  { f: "W8@step4", hot: { h: "w8.continue-reward", l: "Continue" }, who: "David", ev: "sets the declared reward rail and its reference", cite: "CS:726" },
  { f: "W8@step5", hot: { h: "w8.seed", l: "Seed this commitment" }, who: "David", ev: "seedCycle records the new Season campaign", cite: "CS:726" },
  { f: "W7", hot: null, who: "David", st: "Open", ev: "the seeded cycle is visible before allocation opens it", cite: "CS:726" },
...
{ id: "sb13", n: 13, title: "Claim a protocol promise for your garden", persona: "Garden steward (Leila)", scen: "S14", reviewVisible: true, reviewGroup: "client", steps: [
  ...
  { f: "W10", hot: null, st: "ReadyForConfirmation", surface: "admin", echo: true, ev: "the garden-provided promise opens awaiting its named confirmations", cite: "UX:318" },
  { f: "W10@fulfilled", hot: null, st: "Fulfilled", surface: "admin", echo: true, ev: "named confirmer (or reasoned fallback) confirms · co-funded reward references stay with the owning garden · never custody or member-delivery via garden claims", cite: "UX:313 · AM:38-39" },
]},
