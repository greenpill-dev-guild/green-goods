...
{ id: "sb1", n: 1, title: "Offer support and see it kept", persona: "Gardener (Maria) + recipient (João)", scen: "S1 · TAS workshop", reviewVisible: true, reviewGroup: "client", steps: [
  ...
  { f: "W3@step-confirmers", hot: { h: "w3.continue-confirmers", l: "Continue" }, who: "Maria", st: "Draft (local)", ev: "ordinary reachability is shown and the explicit Green Goods team fallback choice is preserved for review", cite: "UX §5.4" },
...
{ id: "sb6a", n: 6, title: "Offer again after a promise expires", persona: "Promise owner", scen: "S1/S5 edge", reviewVisible: true, reviewGroup: "client", steps: [
  ...
  { f: "W3@step-confirmers", hot: { h: "w3.continue-confirmers", l: "Continue" }, who: "owner", st: "Prefilled draft", ev: "the owner checks receiver reachability and explicitly keeps or clears Green Goods team fallback", cite: "UX §5.4" },
