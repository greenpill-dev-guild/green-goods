...
{ id: "sb4a", n: 8, title: "Prove it with work", desc: "A gardener submits work from the Garden tab and points it at the commitment it fulfills; each approval counts toward one named requirement.", persona: "Gardener (provider)", scen: "S4 · AGRO+EDU", reviewVisible: true, reviewGroup: "client", chapter: "keep", roles: ["gardener"], steps: [
  ...
  { f: "WFLOW@details", hot: { h: "wflow.fulfills-field", l: "Fulfills a commitment" }, st: "3 · Details", ev: "work-first: pick the commitment this work fulfills — or none; commitment-first entry arrives here prefilled and locked" },
  { f: "WFLOW@fulfills-pick", hot: { h: "wflow.pick-done", l: "Use this commitment" }, st: "Picker", ev: "your open garden-work commitments in this garden; approved work counts toward the one you pick" },
  { f: "WFLOW@details-linked", hot: { h: "wflow.details-continue" }, st: "3 · Details", ev: "the chosen commitment sits in the details like any other field — plain work that skips the picker never carries one" },
...
{ id: "sb42", n: 9, title: "Confirm a commitment kept", desc: "João finds what is waiting on him in the wallet and confirms the commitment was kept — a positive-only act that queues offline.", persona: "Recipient (João)", scen: "S1 · confirmation", reviewVisible: true, reviewGroup: "client", chapter: "confirm", roles: ["gardener"], steps: [
  ...
  { f: "W2@fulfilled", hot: null, st: "Fulfilled", ev: "kept, once — the commitment carries who confirmed and how; no duplicate full-screen repeat", br: [{ l: "Request, campaign, service, and recorded-commitment casts", to: "screen:W4@confirm-request" }] },
]},
...
{ id: "sb37", n: 3, title: "Make an ongoing offer", desc: "Maria offers the same service over time: How often becomes Ongoing, and one submission creates the series and its first open places.", persona: "Gardener (Maria)", scen: "S15 · ongoing Offer", reviewVisible: true, reviewGroup: "client", chapter: "make", roles: ["gardener"], steps: [
  ...
  { f: "W34@story", hot: null, st: "Story", ev: "what the ongoing offer has become — kept commitments, people, no scores", br: [{ l: "Rest it without erasure", to: "screen:W34@resting" }, { l: "Retire it — the story stays readable", to: "screen:W34@retired" }, { l: "Take up one open place (recipient side)", to: "screen:W34@claimant-view" }] },
]},
...
{ id: "sb3b", n: 3, title: "Decide who takes up a commitment", desc: "Two neighbors asked for the same scarce place: David declines one with a reason, accepts the other, and the rest are superseded.", persona: "Steward (David)", scen: "S3 · scarce crew slots", reviewVisible: true, reviewGroup: "admin", chapter: "commitments", roles: ["steward"], steps: [
...
{ id: "sb14", n: 14, title: "Turn a neighbor's need into a seeded commitment", desc: "Kwame describes a need in his own words, neighbors support it, and a steward turns the thread into a seeded commitment.", persona: "Neighbour (Kwame) + steward", scen: "S10 · September", reviewVisible: false, reviewGroup: "admin", chapter: "commitments", roles: ["steward"], steps: [
  ...
  { f: "C5", hot: null, surface: "community", marks: ["✓ Commitment: 16 market rides this season"], ev: "the thread: neighbor's words → commitment → work → proof · funding supports the garden, never escrow", cite: "CI-WF:165" },
