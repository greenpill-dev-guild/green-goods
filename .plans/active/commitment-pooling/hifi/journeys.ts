...
{ id: "sb8", n: 8, title: "Record a promise for a device-free member", persona: "Steward (David) + member (Kwame)", scen: "S7 · device-free member", reviewVisible: true, reviewGroup: "admin", steps: [
  ...
  { f: "W2a@compose-captured", hot: { h: "w2a.attach-captured", l: "Attach evidence" }, who: "Kwame", surface: "pwa", echo: true, st: "Evidence draft", ev: "the evidence composer preserves OperatorCaptured and Kwame as the promise source", cite: "CS:739 · UX:437" },
  ...
  { f: "W2@captured-evidence-submitted", hot: { h: "w2.send-confirmation-captured", l: "Send for confirmation" }, who: "Kwame", surface: "pwa", echo: true, st: "EvidenceSubmitted", ev: "OperatorCaptured uses the evidence-only readiness call; no linked work is invented", cite: "CS:741" },
  ...
  { f: "W4@confirmed-captured", hot: { h: "w4.done-captured", l: "Back to the pool" }, who: "Ana", surface: "pwa", echo: true, st: "Fulfilled", ev: "sync completion shows the quiet result for the same OperatorCaptured promise", cite: "UX:197-204" },
