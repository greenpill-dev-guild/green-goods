...
{ id: "sb2", n: 2, title: "Ask for help and confirm it arrived", persona: "Gardener (Ana)", scen: "S2 · evidence-only", reviewVisible: true, reviewGroup: "client", chapter: "ask", roles: ["gardener"], steps: [
  ...
  { f: "W2@request-evidence-submitted", hot: null, st: "EvidenceSubmitted", ev: "João attaches the ride evidence and sends it for confirmation — evidence-only, no work gate; the promise stays Ana's request throughout", cite: "CS:1233 · UX:214" },
...
{ id: "sb43", n: 43, title: "Help with what was asked", persona: "Helper (João)", scen: "S2 · evidence-only", reviewVisible: true, reviewGroup: "client", chapter: "ask", roles: ["gardener"], steps: [
  ...
  { f: "W2@request-evidence-submitted", hot: { h: "w2.send-confirmation-request" }, who: "João", st: "EvidenceSubmitted", ev: "confirmation{submit} → ReadyForConfirmation (creator, counterparty, or steward may send)", cite: "CS:1233", mf: true },
...
{ id: "sb51", n: 51, title: "Ask for garden work and see it approved", persona: "Gardener (Ana) + helper (João)", scen: "S2 · DomainImpact request", reviewVisible: true, reviewGroup: "client", chapter: "ask", roles: ["gardener"], steps: [
  ...
  { f: "W1@request-work-open", hot: null, who: "Ana", st: "Requested · open for claim", ev: "the synced ask is open to the garden — its required actions are named on the card so anyone deciding to help knows what the proof will be", cite: "CS:133" },
  { f: "W2@request-work-active", hot: null, marks: ["w2.submit-work-request-detail"], st: "Requested → Active", ev: "João takes it up and submits work on the ordinary rails — approvalscount toward the ask's requirements", cite: "CS:737", br: [{ l: "Work approval, steward side", to: "sb4b:0" }] },
  ...
  { f: "W2@request-work-ready-confirmer", hot: null, st: "ReadyForConfirmation", ev: "both approvals counted — Ana, who asked, confirms next; every contributor stays excluded", cite: "CS:139 · CS §6.1" },
  { f: "W4@confirm-request-work", hot: { h: "w4.confirm-request-work", l: "Confirm — the work was done" }, who: "Ana", st: "ReadyForConfirmation", ev: "the ask keeps its own cast to the last step: approved Work is the proof shown here, never an evidence count", cite: "CS:139" },
  { f: "W4@confirmed-pending-request-work", hot: null, who: "Ana", st: "Pending local sync", ev: "the confirmation is saved without showing fulfillment early", cite: "UX:169,221" },
  { f: "W4@confirmed-request-work", hot: null, who: "Ana", st: "Fulfilled", ev: "sync completion shows the quiet result — the ask Ana made was met by approved work", cite: "UX:197-204" },
]},
...
{ id: "sb44", n: 44, title: "A promise recorded for you", persona: "Member (Kwame)", scen: "S7 · device-free member", reviewVisible: true, reviewGroup: "client", chapter: "confirm", roles: ["member", "gardener"], steps: [
  ...
  { f: "W2a@compose-captured", hot: { h: "w2a.attach-captured", l: "Attach evidence" }, who: "Kwame", st: "Evidence draft", ev: "the evidence composer preserves StewardCaptured and Kwame as the promise source", cite: "CS:1208 · UX:437" },
  ...
  { f: "W2@captured-evidence-submitted", hot: { h: "w2.send-confirmation-captured", l: "Send for confirmation" }, who: "Kwame", st: "EvidenceSubmitted", ev: "StewardCaptured uses the evidence-only readiness call; no linked work is invented", cite: "CS:1233" },
...
{ id: "sb52", n: 52, title: "Keep a campaign ask until it's ready to confirm", persona: "Helper (João)", scen: "S1 · campaign request", reviewVisible: true, reviewGroup: "client", chapter: "keep", roles: ["gardener"], steps: [
  ...
  { f: "W2a@compose-campaign-request", hot: { h: "w2a.attach-campaign-request", l: "Attach evidence" }, who: "João", st: "Evidence draft", ev: "the shared composer queues the photo with its credited-contributor vector", cite: "CS:1208" },
  ...
  { f: "W2@campaign-request-evidence-submitted", hot: { h: "w2.send-confirmation-campaign-request", l: "Send for confirmation" }, who: "João", st: "EvidenceSubmitted", ev: "the evidence-only call advances to ReadyForConfirmation without a work gate", cite: "CS:1233", mf: true },
...
{ id: "sb29", n: 29, title: "Offer a service and prove it with evidence", persona: "Gardener (Maria)", scen: "S1 · SupportService offer", reviewVisible: true, reviewGroup: "client", chapter: "make", roles: ["gardener"], steps: [
  ...
  { f: "W2a@compose-support", hot: { h: "w2a.attach-support", l: "Attach evidence" }, who: "Maria", st: "Evidence draft", ev: "the photo, link, or note queues on the ordinary offline evidence rail", cite: "CS:1208" },
  ...
  { f: "W2@support-evidence-submitted", hot: { h: "w2.send-confirmation", l: "Send for confirmation" }, who: "Maria", st: "EvidenceSubmitted", ev: "the evidence-only call advances to ReadyForConfirmation without a work gate", cite: "CS:1233" },
