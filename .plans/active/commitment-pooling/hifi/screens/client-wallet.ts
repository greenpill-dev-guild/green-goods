...
const W23_HOTS: HifiDef["hots"] = {
  ...
  "w23.tech-status": { l: "Technical status", info: "AA/paymaster gate failed: Individual reward delivery + member sends stay off; Garden-claim rewards and steward/owner-initiated non-commitment garden seeding continue Safe-to-Safe (SS §5)." },
};
