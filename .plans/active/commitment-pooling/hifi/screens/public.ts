...
<p style="margin:0;max-width:52ch">Fulfilled commitments shown here are anchored in the certificates below.</p>`;
      break;
    case "pre-launch":
      panel = `<span class="kicker">Commitments</span>
...
<p style="margin:0;max-width:52ch;color:var(--stone)">Fulfilled commitments shown here are anchored in the certificates below.</p>`;
  }
