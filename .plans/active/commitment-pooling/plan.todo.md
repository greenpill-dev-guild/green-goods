...
Every file in this hub, by role — **150 files**: 22 at the hub root, 42 under `artifacts/`,
22 under `handoffs/`, 18 under `hifi/`, 20 under `operations/`, and 26 under `reports/`.
