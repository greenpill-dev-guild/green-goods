...
| `reports/client-loop-pr-feedback-2026-08-22.md` | Ledger and disposition for the 44 PR #749 review threads across three rounds: 30 fixed with root cause and location, 12 deferred with reasons, 1 duplicate, 1 stale — plus the correction that dev mock auth does have a real signer | Dated review evidence — the deferred rows are the remaining work on this branch |
