...
The implementation window closes with the Build phase on 2026-07-31. Research alignment runs through 2026-07-30; the July dry-run operational checkpoint is 2026-07-31. Release follows on 2026-08-12, Community and settlement evidence on 2026-09-30, and Follow On / Hardening on 2026-12-31. These dates do not waive artifact-specific evidence or human authorization gates.
...
7. [ ] Human-authorized tiered Release step (`handoffs/human-release-ops.md`): Build ends July 31 with full tests, dry-runs, post-deploy verification readiness, and upgrade/rollback proof but no broadcast. On or after the August 12 Release date, the pooling module/register/two schemas may use the narrower non-custodial/non-transferable evidence gate only with explicit human authorization; SettlementModule/Safes remain blocked on audit, timelock, two-week testnet, Safe/Functions/AA evidence, live value proof, and their own authorization. Verify artifact addresses, indexer config, schema UIDs, replay switch, and rollback for every authorized tier
