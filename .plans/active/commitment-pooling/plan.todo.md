...
| `reports/client-loop-pr-feedback-2026-08-22.md` | Ledger and disposition for the 28 PR #749 review threads: 18 fixed with root cause and location, 9 deferred with reasons, 1 stale — plus the correction that dev mock auth does have a real signer | Dated review evidence — the deferred rows are the remaining work on this branch |
