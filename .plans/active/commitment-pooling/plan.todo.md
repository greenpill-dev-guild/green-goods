...
| **Full decision register** (further below) | 1–47 | The 2026-07-03 alignment session verbatim, plus dated addenda 28–47 |

- **`#30`–`#47` are unambiguous** — the Decision Log stops at 29, so those are always the register (`#34` alone is cited 71×).
...
### Full decision register (2026-07-03 alignment session, entries 1–27; dated addenda 28–47)
