...
| 25 | Garden 4 selected: a candidate was chosen as the mature MRV-adoption anchor, owning the B4/S12 journey with the es locale proof riding B4. **Superseded by #29; the candidate is deliberately not named in any tracked artifact.** Slotted into RESR-58 Part A/B4 and the reward-path matrix, the July tracking rows, RESR-62/PRD-701/RESR-57 cohort lines, and the external-brief cohort. Pass 1 verifies the five selection criteria as evidence, not assumption. | User selection 2026-07-11 (read out in session; supersedes the deep-research TBD slot). |
