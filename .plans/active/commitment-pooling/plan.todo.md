...
Every file in this hub, by role — **149 files**: 22 at the hub root, 42 under `artifacts/`,
21 under `handoffs/`, 18 under `hifi/`, 20 under `operations/`, and 26 under `reports/`.
