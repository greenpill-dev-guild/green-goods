...
**Stage**: `active`
**Status**: `ACTIVE: pre-build review accepted (register #70) — one blocker and twenty-nine further corrections applied; PRD-757/759 and PRD-762 are cleared; the isolated integration and canonical Google Doc convergence are complete; merge to develop plus live Linear convergence still gate PRD-721 dispatch; value release, Safe authority, audit, canary, and external evidence remain blocked`
**Created**: `2026-07-03`
...
16. [ ] **Walkthrough-video completion (PRD-728):** after QA Pass 2, record, edit, caption, transcribe, privacy-review, and replay the approved client PWA, admin, editorial, member, Garden Steward, evaluator, and operational walkthroughs against the final source SHA.
