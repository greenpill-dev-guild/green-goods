...
1. Save this spec to `.plans/active/public-site-editorial-polish/plan.todo.md` for repo execution truth.
...
spec is .plans/active/public-site-editorial-polish/plan.todo.md (copy it there from
