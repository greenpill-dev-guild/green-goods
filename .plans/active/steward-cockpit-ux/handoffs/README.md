...
Keep lane handoffs short and factual. The work runs as five PRs, one execution sub-lane each:

- `pr1-actions-crash.md` (`pr1_actions_crash`)
- `pr2-hub-review-queue.md` (`pr2_hub_review_queue`)
- `pr3-garden-community.md` (`pr3_garden_community`)
- `pr4-shell-cookies-tone.md` (`pr4_shell_cookies_tone`)
- `pr5-copy-storybook-polish.md` (`pr5_copy_storybook_polish`)

Canonical lanes aggregate TDD proof and the QA passes:
...
The `contracts` lane is `n/a` (`codex-contracts.md` says why).
