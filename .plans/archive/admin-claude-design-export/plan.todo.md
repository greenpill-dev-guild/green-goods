...
**Status**: `ARCHIVED — SUPERSEDED REFERENCE` — removed from the live backlog on 2026-07-19; current admin guidance and fresh captures own any future export.
...
.plans/archive/admin-claude-design-export/scripts/bundle-export.sh

# Skip Storybook rebuild (use existing storybook-static/)
.plans/archive/admin-claude-design-export/scripts/bundle-export.sh --skip-rebuild

# All variants (~286 PNGs)
.plans/archive/admin-claude-design-export/scripts/bundle-export.sh --variants=all

# Text-only refresh (no screenshots)
.plans/archive/admin-claude-design-export/scripts/bundle-export.sh --skip-captures
```
