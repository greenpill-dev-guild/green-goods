...
Use **TodoWrite** for visibility when available. If unavailable, keep a Markdown checklist in the response. See `AGENTS.md` → Session Continuity.
...
4. **Review AGENTS.md** for compliance rules
...
- **Ignoring AGENTS.md compliance** — Plans that skip the compliance checklist produce non-conforming code
