...
> Sub-file of the [ui skill](./SKILL.md). TailwindCSS v4 configuration, theme system, design tokens, dark mode, custom utilities, and CSS architecture.

---

## Requirements & Architecture

TailwindCSS v4 requires modern browsers (Chrome 111+, Safari 16.4+, Firefox 128+) because it relies on `@property`, cascade layers, native nesting, and `color-mix()`.

The default palette is rebuilt in OKLCH/P3 color space for more perceptually consistent colors.
