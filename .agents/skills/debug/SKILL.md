...
**References**: See `AGENTS.md` for codebase patterns. Use `oracle` for complex investigation, `cracked-coder` for fixes.
...
| Claim | Command |
|-------|---------|
| "Tests pass" | `bun run test` (NOT `bun test` — see AGENTS.md) |
