...
| Condition | Command |
|-----------|---------|
| Changed files under `packages/shared/src/styles/theme.css` or `.agents/skills/design/language.md` | `bun run check:design-tokens` |
...
├─ --pr flag → gh pr create (use the PR creation flow from AGENTS.md)
