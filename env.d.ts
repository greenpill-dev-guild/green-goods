...
declare module 'varlock/env' {
  ...
  export interface PublicTypedEnvSchema extends Readonly<Pick<CoercedEnvSchema, 'VITE_WALLETCONNECT_PROJECT_ID' | 'VITE_PIMLICO_API_KEY' | 'VITE_PASSKEY_RP_ID' | 'VITE_CHAIN_ID' | 'VITE_ALCHEMY_API_KEY' | 'VITE_STORACHA_KEY' | 'VITE_STORACHA_PROOF' | 'VITE_STORACHA_GATEWAY' | 'VITE_ENVIO_INDEXER_URL' | 'VITE_GARDENS_SUBGRAPH_KEY' | 'VITE_POSTHOG_KEY' | 'VITE_POSTHOG_ADMIN_KEY' | 'VITE_POSTHOG_HOST' | 'VITE_POSTHOG_DEBUG' | 'VITE_APP_VERSION' | 'VITE_APP_URL' | 'VITE_API_BASE_URL' | 'VITE_ENABLE_SW_DEV' | 'VITE_ENABLE_RPC_BG_SYNC' | 'VITE_DEBUG_MODE' | 'VITE_QUEUE_DEBUG' | 'VITE_MOCK_PWA_INSTALLED' | 'VITE_OPS_RUNNER_URL' | 'VITE_PIMLICO_SPONSORSHIP_POLICY_ID' | 'VITE_USE_HASH_ROUTER' | 'VITE_RPC_URL_11155111'>> {}
}
