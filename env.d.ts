...
export type CoercedEnvSchema = {
  ...
  /**
   * **PINATA_UPLOAD_JWT_OP_REF** 🔐 _sensitive_  
   * VITE_PINATA_JWT is the primary upload credential because the current upload  
   * path is browser-facing. Set it directly, or use PINATA_UPLOAD_JWT_OP_REF to  
   * resolve it from 1Password. PINATA_JWT remains as a script compatibility alias.  
   * ![icon](data:image/svg+xml;utf-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2220%22%20height%3D%2220%22%20viewBox%3D%220%200%2032%2032%22%3E%3Cpath%20fill%3D%22%23808080%22%20d%3D%22M29%2022h-5a2.003%202.003%200%200%201-2-2v-6a2%202%200%200%201%202-2h5v2h-5v6h5ZM18%2012h-4V8h-2v14h6a2.003%202.003%200%200%200%202-2v-6a2%202%200%200%200-2-2m-4%208v-6h4v6Zm-6-8H3v2h5v2H4a2%202%200%200%200-2%202v2a2%202%200%200%200%202%202h6v-8a2%202%200%200%200-2-2m0%208H4v-2h4Z%22%2F%3E%3C%2Fsvg%3E)   
   */
  PINATA_UPLOAD_JWT_OP_REF?: string;
   ...
   * Keep them explicit here to document the current risk until uploads move  
   * fully server-side.  
   * ![icon](data:image/svg+xml;utf-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2220%22%20height%3D%2220%22%20viewBox%3D%220%200%2032%2032%22%3E%3Cpath%20fill%3D%22%23808080%22%20d%3D%22M29%2022h-5a2.003%202.003%200%200%201-2-2v-6a2%202%200%200%201%202-2h5v2h-5v6h5ZM18%2012h-4V8h-2v14h6a2.003%202.003%200%200%200%202-2v-6a2%202%200%200%200-2-2m-4%208v-6h4v6Zm-6-8H3v2h5v2H4a2%202%200%200%200-2%202v2a2%202%200%200%200%202%202h6v-8a2%202%200%200%200-2-2m0%208H4v-2h4Z%22%2F%3E%3C%2Fsvg%3E)   
   */
  ...
  /**
   * **VITE_STORACHA_GATEWAY** 🔐 _sensitive_  
   * ![icon](data:image/svg+xml;utf-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2220%22%20height%3D%2220%22%20viewBox%3D%220%200%2032%2032%22%3E%3Cpath%20fill%3D%22%23808080%22%20d%3D%22M29%2022h-5a2.003%202.003%200%200%201-2-2v-6a2%202%200%200%201%202-2h5v2h-5v6h5ZM18%2012h-4V8h-2v14h6a2.003%202.003%200%200%200%202-2v-6a2%202%200%200%200-2-2m-4%208v-6h4v6Zm-6-8H3v2h5v2H4a2%202%200%200%200-2%202v2a2%202%200%200%200%202%202h6v-8a2%202%200%200%200-2-2m0%208H4v-2h4Z%22%2F%3E%3C%2Fsvg%3E)   
   */
...
declare module 'varlock/env' {
  ...
  export interface PublicTypedEnvSchema extends Readonly<Pick<CoercedEnvSchema, 'VITE_WALLETCONNECT_PROJECT_ID' | 'VITE_PIMLICO_API_KEY' | 'VITE_PASSKEY_RP_ID' | 'VITE_CHAIN_ID' | 'VITE_ALCHEMY_API_KEY' | 'VITE_PINATA_JWT' | 'VITE_PINATA_GATEWAY_URL' | 'VITE_PINATA_API_URL' | 'VITE_ENVIO_INDEXER_URL' | 'VITE_GARDENS_SUBGRAPH_KEY' | 'VITE_POSTHOG_KEY' | 'VITE_POSTHOG_ADMIN_KEY' | 'VITE_POSTHOG_HOST' | 'VITE_POSTHOG_DEBUG' | 'VITE_APP_VERSION' | 'VITE_APP_URL' | 'VITE_API_BASE_URL' | 'VITE_GOOGLE_APPOINTMENT_URL' | 'VITE_THIRDWEB_CLIENT_ID' | 'VITE_ENABLE_SW_DEV' | 'VITE_ENABLE_RPC_BG_SYNC' | 'VITE_DEBUG_MODE' | 'VITE_QUEUE_DEBUG' | 'VITE_MOCK_PWA_INSTALLED' | 'VITE_PIMLICO_SPONSORSHIP_POLICY_ID' | 'VITE_ERC7677_PROXY_URL' | 'VITE_USE_HASH_ROUTER' | 'VITE_RPC_URL_11155111'>> {}
}
